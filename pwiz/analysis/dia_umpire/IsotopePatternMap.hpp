...
#ifndef _DIAUMPIRE_ISOTOPEPATTERNMAP_
#define _DIAUMPIRE_ISOTOPEPATTERNMAP_
...
{
    double mass;
    std::vector<MzRange> isotopeRanges;
};

typedef std::vector<std::map<double, MzRange>> IsotopePatternMap;

IsotopePatternMap generateIsotopePatternMap(const InstrumentParameter& parameter);

} // namespace DiaUmpire

#endif // _DIAUMPIRE_ISOTOPEPATTERNMAP_
