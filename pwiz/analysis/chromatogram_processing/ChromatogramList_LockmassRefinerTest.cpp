...
void test(const string& filepath, double lockmassMz, double lockmassTolerance)
{
    ...
    ChromatogramList_LockmassRefiner lmr(msd.run.chromatogramListPtr, lockmassMz, lockmassMz, lockmassTolerance);
    ChromatogramListPtr sl(&lmr, boost::null_deleter());
    msd.run.chromatogramListPtr = sl;
