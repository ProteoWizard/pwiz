...
struct SpectrumList_PrecursorRecalculator::Impl
{
    ...
    Impl(shared_ptr<PrecursorRecalculator> _precursorRecalculator)
    :   precursorRecalculator(_precursorRecalculator)
    {}
};
...
PWIZ_API_DECL SpectrumList_PrecursorRecalculator::SpectrumList_PrecursorRecalculator(
    const SpectrumListPtr original, shared_ptr<PrecursorRecalculator> precursorRecalculator)
:   SpectrumListWrapper(original), impl_(new Impl(precursorRecalculator))
{}
...
PWIZ_API_DECL SpectrumPtr SpectrumList_PrecursorRecalculator::spectrum(size_t index, bool getBinaryData) const
{
    ...
    // TODO:  use PrecursorRecalculator here
