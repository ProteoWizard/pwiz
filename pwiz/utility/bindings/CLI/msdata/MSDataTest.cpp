...
void testReader()
{
    ...
    unit_assert(typeSet->Contains("ABSciex WIFF"));
    ...
    unit_assert(typeExtMap->ContainsKey("ABSciex WIFF") && typeExtMap["ABSciex WIFF"]->Count == 2 && typeExtMap["ABSciex WIFF"][0] == ".wiff" && typeExtMap["ABSciex WIFF"][1] == ".wiff2");
