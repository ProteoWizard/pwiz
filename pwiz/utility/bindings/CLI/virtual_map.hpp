...
{ \
    internal: WrapperName(pwiz::util::virtual_map<NativeKeyType, NativeValueType>* base, System::Object^ owner) : base_(base), owner_(owner) {LOG_CONSTRUCT(BOOST_PP_STRINGIZE(WrapperName))} \
              WrapperName(pwiz::util::virtual_map<NativeKeyType, NativeValueType>* base) : base_(base), owner_(nullptr) {LOG_CONSTRUCT(BOOST_PP_STRINGIZE(WrapperName))} \
              ...
              pwiz::util::virtual_map<NativeKeyType, NativeValueType>* base_; \
              System::Object^ owner_; \
\
    public: ModificationBaseMap() : base_(new pwiz::util::virtual_map<NativeKeyType, NativeValueType>()) {} \
\
...
\
    ...
    { \
        ...
        { \
            ...
            for(pwiz::util::virtual_map<NativeKeyType, NativeValueType>::iterator itr = base_->begin(); itr != base_->end(); ++itr) \
...
\
    ...
    { \
        pwiz::util::virtual_map<NativeKeyType, NativeValueType>::iterator itr = base_->find(CLIKeyToNative(NativeKeyType, key)); \
        if(itr != base_->end()) \
        { \
...
\
    ...
    { \
        internal: pwiz::util::virtual_map<NativeKeyType, NativeValueType>* base_; \
                  pwiz::util::virtual_map<NativeKeyType, NativeValueType>::iterator* itr_; \
                  bool isReset_; \
        \
        public: Enumerator(pwiz::util::virtual_map<NativeKeyType, NativeValueType>* base) : base_(base), itr_(new pwiz::util::virtual_map<NativeKeyType, NativeValueType>::iterator), isReset_(true) {} \
        \
