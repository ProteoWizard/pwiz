...
bool SpectrumList_FilterPredicate_Custom::done()
{
    return false;
}
...
: msdata::SpectrumList(0), userManagedPredicate(predicate)
{
    userManagedPredicateWrapper = gcnew SpectrumList_FilterAcceptSpectrumWrapper(this, &SpectrumList_Filter::marshal);
    System::IntPtr predicatePtr = System::Runtime::InteropServices::Marshal::GetFunctionPointerForDelegate(userManagedPredicateWrapper);
...
{
    base_ = new b::SpectrumList_Filter(*inner->base_, *managedPredicate->base_);
    msdata::SpectrumList::base_ = new boost::shared_ptr<pwiz::msdata::SpectrumList>(base_);
}
