...
Usage (run from repo root):
    python pwiz/data/common/generate_cvid.py
"""
...
OUT = REPO / "pwiz/data/common/CVID.generated.cs"

HEADER = """// This file is generated from pwiz/data/common/cv.hpp.
// Do not edit by hand — run pwiz/data/common/generate_cvid.py to regenerate.
