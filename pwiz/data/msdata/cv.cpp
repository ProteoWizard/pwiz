...
const TermInfo termInfos_[] =
{
    ...
    {MS_constant_neutral_loss_scan, "MS:1000323", "constant neutral loss scan", "A scan procedure for a tandem mass spectrometer designed to produce a constant neutral loss spectrum of different precursor ions by detection of the corresponding product ions produced by metastable ion fragmentation or collision-induced dissociation. Synonymous terms are constant neutral mass loss scan and fixed neutral fragment scan."},
    {MS_constant_neutral_gain_scan, "MS:1000324", "constant neutral gain scan", "Scan procedure for a tandem mass spectrometer designed to produce a constant neutral mass gain spectrum of different precursor ions by detection of the corresponding product ions of ion/molecule reactions with a gas in acollision cell."},
    ...
    {MS_Thermo_nativeID_format, "MS:1000768", "Thermo nativeID format", "controller=xsd:nonNegativeInteger scan=xsd:positiveInteger."},
