...
const TermInfo termInfos_[] =
{
    ...
    {MS_scan_time, "MS:1000016", "scan time", "The time that an analyzer started a scan, relative to the start of the run."},
    ...
    {MS_binary_data_type, "MS:1000518", "binary data type", "Binary Data type. 16-bit integer, 32-bit integer, 32-bit float 64-bit integer 64-bit float."},
    ...
    {MS_Waters_DAT_file, "MS:1000526", "Waters DAT file", "Waters DAT file format, storing a single function recorded by the instrument in a Waters RAW directory."},
    ...
    {MS_isolation_window_upper_limit, "MS:1000793", "isolation window upper limit", "The highest m/z being isolated in an isolation window."},
    {MS_isolation_window_lower_limit, "MS:1000794", "isolation window lower limit", "The lowest m/z being isolated in an isolation window."},
...
CVIDPair relationsIsA_[] =
{
    ...
    {MS_Waters_DAT_file, MS_source_file_type},
    ...
    {MS_isolation_window_upper_limit, MS_isolation_window_attribute},
    {MS_isolation_window_lower_limit, MS_isolation_window_attribute},
