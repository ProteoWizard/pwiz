...
const TermInfo termInfos_[] =
{
    ...
    {MS_electromagnetic_radiation_chromatogram_, "MS:1000811", "electromagnetic radiation chromatogram ", "The measurement of electromagnetic properties as a function of the retention time."},
    {MS_absorption_chromatogram_, "MS:1000812", "absorption chromatogram ", "The measurement of light absorbed by the sample as a function of the retention time."},
    {MS_emission_chromatogram__, "MS:1000813", "emission chromatogram  ", "The measurement of light emitted by the sample as a function of the retention time."},
...
CVIDPair relationsIsA_[] =
{
    ...
    {MS_Waters_raw_file, MS_source_file_type},
    ...
    {MS_ABI_WIFF_file, MS_source_file_type},
    {MS_Thermo_RAW_file, MS_source_file_type},
    {MS_PSI_mzData_file, MS_source_file_type},
    {MS_Micromass_PKL_file, MS_source_file_type},
    {MS_ISB_mzXML_file, MS_source_file_type},
    {MS_Bruker_Agilent_YEP_file, MS_source_file_type},
    ...
    {MS_parameter_file, MS_source_file_type},
    {MS_Conversion_to_dta, MS_file_format_conversion},
    {MS_Bioworks_SRF_file, MS_source_file_type},
    ...
    {MS_electromagnetic_radiation_chromatogram_, MS_data_file_content},
    {MS_electromagnetic_radiation_chromatogram_, MS_chromatogram_type},
    {MS_absorption_chromatogram_, MS_data_file_content},
    {MS_absorption_chromatogram_, MS_electromagnetic_radiation_chromatogram_},
    {MS_emission_chromatogram__, MS_data_file_content},
    {MS_emission_chromatogram__, MS_electromagnetic_radiation_chromatogram_},
    {MS_counts_per_second, MS_intensity_unit},
    {MS_Bruker_BAF_file, MS_source_file_type},
    {MS_Bruker_U2_file, MS_source_file_type},
    ...
    {MS_Bruker_FID_file, MS_source_file_type},
...
CVIDPair relationsPartOf_[] =
{
    ...
    {MS_native_spectrum_identifier_format, MS_data_file},
...
CVIDStringPair relationsExactSynonym_[] =
{
    ...
    {MS_electromagnetic_radiation_chromatogram_, "EMR radiation chromatogram"},
    {UO_meter, "m"},
    {UO_kilogram, "kg"},
    {UO_second, "s"},
    {UO_ampere, "A"},
