...
const TermInfo termInfos_[] =
{
    ...
    {MS_selected_m_z, "MS:1000744", "selected m/z", "Mass-to-charge ratio of the ion selected for fragmentation"},
    ...
    {MS_isolation_m_z_upper_limit, "MS:1000793", "isolation m/z upper limit", "The highest m/z being isolated in an isolation window."},
    {MS_isolation_m_z_lower_limit, "MS:1000794", "isolation m/z lower limit", "The lowest m/z being isolated in an isolation window."},
...
CVIDPair relationsIsA_[] =
{
    ...
    {MS_selected_m_z, MS_ion_selection_attribute},
    ...
    {MS_isolation_m_z_upper_limit, MS_isolation_window_attribute},
    {MS_isolation_m_z_lower_limit, MS_isolation_window_attribute},
