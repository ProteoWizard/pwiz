...
const TermInfo termInfos_[] =
{
    ...
    {MS_binary_data_type, "MS:1000518", "binary data type", "Encoding type of binary data, e.g. 64-bit float.", false},
    {MS_32_bit_integer_OBSOLETE, "MS:1000519", "32-bit integer", "Signed 32-bit integer.", true},
    {MS_16_bit_float_OBSOLETE, "MS:1000520", "16-bit float", "Signed 16-bit float.", true},
    {MS_32_bit_float, "MS:1000521", "32-bit float", "Signed 32-bit float. IEEE-754.", false},
    {MS_64_bit_integer_OBSOLETE, "MS:1000522", "64-bit integer", "Signed 64-bit integer.", true},
    {MS_64_bit_float, "MS:1000523", "64-bit float", "Signed 64-bit float. IEEE-754.", false},
    ...
    {MS_database_local_file_path, "MS:1001014", "database local file path", "Local file path of the search database from the search engine's point of view.", false},
    ...
    {MS_database_version, "MS:1001016", "database version", "Version of the search database .", false},
    {MS_database_release_date, "MS:1001017", "database release date", "Release date of the search database.", false},
    {MS_database_type, "MS:1001018", "database type", "Database containing amino acid or nucleic acid sequences.", false},
    {MS_database_filtering, "MS:1001019", "database filtering", "Was there filtering used on the database(s), public or private.", false},
    {MS_DB_filter_taxonomy, "MS:1001020", "DB filter taxonomy", "The taxonomy filter applied (if any) to the database search.", false},
    ...
    {MS_DB_filter_on_sequences, "MS:1001027", "DB filter on sequences", "Filtering applied specifically by amino acid sequence pattern.", false},
    ...
    {MS_date___time_search_performed, "MS:1001035", "date / time search performed", "Date and time of the actual search run.", false},
    ...
    {MS_multiple_enzyme_combination_rules, "MS:1001051", "multiple enzyme combination rules", "Description of multiple enzyme digestion protocol, if any.", false},
    ...
    {MS_tolerance_on_types, "MS:1001057", "tolerance on types", "Tolerance on types.", false},
    ...
    {MS_quality_estimation_details, "MS:1001060", "quality estimation details", "Method for quality estimation (manually or wih decoy database).", false},
    ...
    {MS_database_type_AA, "MS:1001073", "database type AA", "Database contains amino acid sequences.", false},
    {MS_database_type_NA, "MS:1001079", "database type NA", "Database contains nucleid acid sequences.", false},
    ...
    {MS_coverage, "MS:1001093", "coverage", "The percent coverage for the protein based upon the matched peptide sequences (can be calculated).", false},
    ...
    {MS_scan_number_s_, "MS:1001115", "scan number(s)", "Take from mzData. TODO: What does this mean?", false},
    ...
    {MS______KR______P_, "MS:1001176", "(?<=[KR])(?\\!P)", "", false},
    ...
    {MS_DB_composition_forward_decoy, "MS:1001197", "DB composition forward+decoy", "Decoy database composition: database contains original (forward) and decoy entries.", false},
    ...
    {MS_frag__y_ion, "MS:1001220", "frag: y ion", "Type of fragment: y ion (ADD more documentation here).", false},
    {MS_fragmentation_information, "MS:1001221", "fragmentation information", "Fragmentation information like ion types.", false},
    {MS_frag__b_ion___H2O, "MS:1001222", "frag: b ion - H2O", "Type of fragment: b ion without water (ADD more documentation here).", false},
    {MS_frag__y_ion___H2O, "MS:1001223", "frag: y ion - H2O", "Type of fragment: y ion without water (ADD more documentation here).", false},
    {MS_frag__b_ion, "MS:1001224", "frag: b ion", "Type of fragment: b ion (ADD more documentation here).", false},
    ...
    {MS_product_ion_m_z_error, "MS:1001227", "product ion m/z error", "The product ion m/z error (ADD more docu here).", false},
    {MS_frag__x_ion, "MS:1001228", "frag: x ion", "Type of fragment: x ion (ADD more documentation here).", false},
    {MS_frag__a_ion, "MS:1001229", "frag: a ion", "Type of fragment: a ion (ADD more documentation here).", false},
    {MS_frag__z_ion, "MS:1001230", "frag: z ion", "Type of fragment: z ion (ADD more documentation here).", false},
    {MS_frag__c_ion, "MS:1001231", "frag: c ion", "Type of fragment: c ion (ADD more documentation here).", false},
    {MS_frag__b_ion___NH3, "MS:1001232", "frag: b ion - NH3", "Type of fragment: b ion without ammonium ion (ADD more documentation here).", false},
    {MS_frag__y_ion___NH3, "MS:1001233", "frag: y ion - NH3", "Type of fragment: y ion without ammonium ion (ADD more documentation here).", false},
    {MS_frag__a_ion___H2O, "MS:1001234", "frag: a ion - H2O", "Type of fragment: a ion without water (ADD more documentation here).", false},
    {MS_frag__a_ion___NH3, "MS:1001235", "frag: a ion - NH3", "Type of fragment: a ion without ammonium ion (ADD more documentation here).", false},
    {MS_frag__d_ion, "MS:1001236", "frag: d ion", "Type of fragment: d ion (ADD more documentation here).", false},
    {MS_frag__v_ion, "MS:1001237", "frag: v ion", "Type of fragment: v ion (ADD more documentation here).", false},
    {MS_frag__w_ion, "MS:1001238", "frag: w ion", "Type of fragment: w ion (ADD more documentation here).", false},
    {MS_frag__immonium_ion, "MS:1001239", "frag: immonium ion", "Type of fragment: immonium ion (ADD more documentation here).", false},
    {MS_non_identified_ion, "MS:1001240", "non-identified ion", "Non-identified ion (ADD more documentation here).", false},
    {MS_co_eluting_ion, "MS:1001241", "co-eluting ion", "Co-eluting ion (ADD more documentation here).", false},
    ...
    {MS_lab_personnell, "MS:1001270", "lab personnell", "", false},
    {MS_researcher, "MS:1001271", "researcher", "", false},
    {MS_____R_____P_, "MS:1001272", "(?<=R)(?\\!P)", "", false},
    ...
    {MS_TODO_add_others, "MS:1001326", "TODO_add_others", "", false},
    ...
    {MS______FYWL______P_, "MS:1001332", "(?<=[FYWL])(?\\!P)", "", false},
    {MS_____M_, "MS:1001333", "(?<=M)", "", false},
    {MS______D_______D__, "MS:1001334", "((?<=D))|((?=D))", "", false},
    {MS_____K_____P_, "MS:1001335", "(?<=K)(?\\!P)", "", false},
    {MS_____K_, "MS:1001336", "(?<=K)", "", false},
    {MS______FL__, "MS:1001337", "(?<=[FL])", "", false},
    {MS______FYWLKR______P_, "MS:1001338", "(?<=[FYWLKR])(?\\!P)", "", false},
    {MS______KR__, "MS:1001339", "(?<=[KR])", "", false},
    {MS______BDEZ______P_, "MS:1001340", "(?<=[BDEZ])(?\\!P)", "", false},
    {MS______EZ______P_, "MS:1001341", "(?<=[EZ])(?\\!P)", "", false},
    ...
    {MS_taxonomy__common_name, "MS:1001468", "taxonomy: common name", "This term is used if a common name is specified, e.g. human.", false},
    {MS_taxonomy__scientific_name, "MS:1001469", "taxonomy: scientific name", "This term is used if a scientific name is specified, e.g. Homo sapiens.", false},
    {MS_taxonomy__Swiss_Prot_ID, "MS:1001470", "taxonomy: Swiss-Prot ID", "This term is used if a swiss prot taxonomy id is specified, e.g. Human.", false},
...
CVIDPair relationsIsA_[] =
{
    ...
    {MS_32_bit_integer_OBSOLETE, MS_binary_data_type},
    {MS_16_bit_float_OBSOLETE, MS_binary_data_type},
    {MS_32_bit_float, MS_binary_data_type},
    {MS_64_bit_integer_OBSOLETE, MS_binary_data_type},
