...
const TermInfo termInfos_[] =
{
    ...
    {MS_DB_filter_taxonomy_OBSOLETE, "MS:1001020", "DB filter taxonomy", "The taxonomy filter applied (if any) to the database search.", true},
    ...
    {MS_Agilent_MassHunter_file, "MS:0100509", "Agilent MassHunter file", "A data file found in an Agilent MassHunter directory which contains raw data acquired by an Agilent mass spectrometer.", false},
...
CVIDPair relationsIsA_[] =
{
    ...
    {MS_DB_filter_taxonomy_OBSOLETE, MS_database_filtering},
    ...
    {MS_no_threshold, MS_quality_estimation_details},
