...
const TermInfo termInfos_[] =
{
    ...
    {MS_intermediate_analysis_format, "MS:1001040", "intermediate analysis format", "Type of the source file, the  AnalysisXML was created from."},
    ...
    {MS_protein_taxonomy, "MS:1001089", "protein taxonomy", "The taxonomy of the resultant protein from the search."},
    {MS_taxonomy_nomenclature, "MS:1001090", "taxonomy nomenclature", "The system used to indicate taxonomy. There should be an enumerated list of options: latin name, NCBI TaxID, common name, Swiss-Prot species ID (ex. RABIT from the full protein ID ALBU_RABIT)."},
    ...
    {MS_data_stored_in_database, "MS:1001107", "data stored in database", "Source file for this AnalysisXML was a data set in a database."},
    ...
    {MS_regular_expression, "MS:1001180", "regular expression", "Branch containing regular expressions for cleavage enzymes."},
    ...
    {MS_Mascot_DAT_file, "MS:1001199", "Mascot DAT file", "Source file for this AnalysisXML was a Mascot DAT file."},
    {MS_Sequest_out_file, "MS:1001200", "Sequest out file", "Source file for this AnalysisXML was ONE Sequest out file."},
    ...
    {MS_search_result_details, "MS:1001213", "search result details", "Scores and global result characteristics."},
    ...
    {MS_Sequest_out_folder, "MS:1001242", "Sequest out folder", "Source file for this AnalysisXML was a Sequest folder with its out files."},
    {MS_Sequest_summary, "MS:1001243", "Sequest summary", "Source file for this AnalysisXML was a Sequest summary page (proteins)."},
    ...
    {MS_ProteinScape_SearchEvent, "MS:1001275", "ProteinScape SearchEvent", "Source data for this AnalysisXML was a ProteinScape SearchEvent."},
    {MS_ProteinScape_Gel, "MS:1001276", "ProteinScape Gel", "Source data for this AnalysisXML was a ProteinScape Gel."},
    ...
    {MS_xtandem_expect, "MS:1001330", "xtandem:expect", "The Xtandem expectation value."},
    {MS_xtandem_hyperscore, "MS:1001331", "xtandem:hyperscore", "The tandem hyperscore."},
    ...
    {MS_OMSSA_csv_file, "MS:1001399", "OMSSA csv file", "Source file for this AnalysisXML was an OMSSA csv file."},
    {MS_OMSSA_xml_file, "MS:1001400", "OMSSA xml file", "Source file for this AnalysisXML was an OMSSA xml file."},
    {MS_tandem_xml_file, "MS:1001401", "tandem xml file", "Source file for this AnalysisXML was an tandem xml file."},
    ...
    {MS_MGF_scans, "MS:1001414", "MGF scans", "This term can hold the scans attribute from an MGF input file."},
    {MS_MGF_raw_scans, "MS:1001415", "MGF raw scans", "This term can hold the raw scans attribute from an MGF input file."},
    ...
    {MS_pepXML_file, "MS:1001421", "pepXML file", "Source file for this AnalysisXML was a pepXML file."},
    {MS_protXML_file, "MS:1001422", "protXML file", "Source file for this AnalysisXML was a protXML file."},
...
CVIDPair relationsIsA_[] =
{
    ...
    {MS_protein_result_details, MS_search_result_details},
    ...
    {MS_protein_taxonomy, MS_protein_result_details},
    {MS_taxonomy_nomenclature, MS_protein_taxonomy},
    ...
    {MS_peptide_result_details, MS_search_result_details},
    ...
    {MS_search_engine_specific_score, MS_search_result_details},
    ...
    {MS_prot_global_FDR, MS_search_result_details},
    ...
    {MS_____R_____P_, MS_regular_expression},
    {MS_____BD__, MS_regular_expression},
    {MS_____DE__, MS_regular_expression},
    ...
    {MS______FYWL______P_, MS_regular_expression},
    {MS_____M_, MS_regular_expression},
    {MS______D_______D__, MS_regular_expression},
    {MS_____K_____P_, MS_regular_expression},
    {MS_____K_, MS_regular_expression},
    {MS______FL__, MS_regular_expression},
    {MS______FYWLKR______P_, MS_regular_expression},
    {MS______KR__, MS_regular_expression},
    {MS______BDEZ______P_, MS_regular_expression},
    {MS______EZ______P_, MS_regular_expression},
    ...
    {MS_number_of_unmatched_peaks, MS_search_result_details},
    {MS_peptide_unique_to_one_protein, MS_peptide_sharing_details},
    {MS_pep_global_FDR, MS_search_result_details},
    ...
    {MS_tandem_xml_file, MS_intermediate_analysis_format},
    ...
    {MS_MGF_scans, MS_spectrum_identification_result_details},
    {MS_MGF_raw_scans, MS_spectrum_identification_result_details},
...
CVIDPair relationsPartOf_[] =
{
    ...
    {MS_regular_expression, MS_spectrum_interpretation},
    {MS_search_result_details, MS_spectrum_interpretation},
    {MS_search_input_details, MS_spectrum_interpretation},
    {MS_role_type, MS_spectrum_interpretation},
