                         ...
                         const Config& config) const
{
    ...
    CompassDataPtr compassDataPtr(CompassData::create(rootpath.string(), config.combineIonMobilitySpectra, format, 
        format == Reader_Bruker_Format_TDF && config.combineIonMobilitySpectra ? 0 : config.preferOnlyMsLevel, // Both at once messes up indexing
        config.allowMsMsWithoutPrecursor, config.isolationMzAndMobilityFilter));
