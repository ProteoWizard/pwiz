...
public class ReaderSciexTests
{
    private static string? FindTestDataRoot()
    {
        ...
        {
            string candidate = Path.Combine(dir, "pwiz", "data", "vendor_readers", "Sciex",
                "Reader_Sciex_Test.data");
    ...
    public void Reader_Sciex_50uMpyrone_8uL_01_simAsSpectra()
    {
        ...
        // untested for years; we now ship it under Reader_Sciex_Test.data/ alongside the
    ...
    private static FixtureRunContext? SetUp(string fixtureFileName)
    {
        ...
        // live under pwiz/data/vendor_readers/Sciex/Reader_Sciex_Test.data/. Prefer the
