...
class PWIZ_API_DECL ChromatogramList_Mobilion : public ChromatogramListBase
{
    public:
    ...
    ChromatogramList_Mobilion(const MBIFilePtr& rawdata, const Reader::Config& config);
