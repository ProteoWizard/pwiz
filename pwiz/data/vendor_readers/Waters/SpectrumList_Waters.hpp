...
class PWIZ_API_DECL SpectrumList_Waters : public SpectrumListIonMobilityBase
{
    ...
    void getCombinedSpectrumData(int function, int block, BinaryData<double>& mz, BinaryData<double>& intensity, BinaryData<double>& driftTime, bool ignoreZeroIntensityPoints) const;
