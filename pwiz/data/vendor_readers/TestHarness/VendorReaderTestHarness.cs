...
public static class VendorReaderTestHarness
{
        ...
        out bool readSucceeded)
    {
        ...
        // cpp vendor TC config — pwiz/data/vendor_readers/<Vendor>/test/Reference/ is opt-in
        // per test project (csproj copies Reference/*.mzML into bin). See
        // pwiz/data/vendor_readers/UNIFI/test/Reference/README.md for the rationale.
