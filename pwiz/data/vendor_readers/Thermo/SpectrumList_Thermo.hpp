...
class PWIZ_API_DECL SpectrumList_Thermo : public SpectrumListIonMobilityBase
{
    ...
    size_t findPrecursorSpectrumIndex(RawFile* raw, int precursorMsLevel, double isolationMz, double precursorIsolationMz, size_t index, int& nonPrecursorMasterScanNumber) const;
