...
/// <list type="number">
///   <item><c>pwiz-sharp/pwiz/data/vendor_readers/UNIFI/test/Reference/&lt;run-id&gt;.mzML</c> — pwiz-sharp-only
...
public class ReaderUnifiHarnessTests
{
    ...
    public void Reader_UNIFI_HarnessAgainstReferenceUrls()
    {
        ...
        string overrideRoot = FindOverrideReferenceRoot()
            ?? throw new InvalidOperationException(
                ...
                + "(expected pwiz/data/vendor_readers/UNIFI/test/Reference under the source tree).");
    ...
    private static string? FindOverrideReferenceRoot()
    {
        ...
        try { return Pwiz.TestHarness.PwizSharpPaths.VendorTestReferenceDir("UNIFI"); }
        catch { return null; }
    }
}
