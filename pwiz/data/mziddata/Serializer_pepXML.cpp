...
string base_name(const MzIdentML& mzid, const string& filepath)
{
...
void start_msms_pipeline_analysis(XMLWriter& xmlWriter, const MzIdentML& mzid, const string& filepath)
{
