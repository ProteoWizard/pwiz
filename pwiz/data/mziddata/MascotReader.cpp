...
#include "pwiz/data/mziddata/MzidPredicates.hpp"
...
public:
    ...
    void addMzid(ms_mascotresfile& file, MzIdentML& result)
    {
        result.id = "MZID";
    ...
    void addMascotSoftware(ms_mascotresfile & file, MzIdentML& mzid)
    {
    ...
    void addSearchDatabases(ms_mascotresfile & file, MzIdentML& mzid)
    {
    ...
    void addUser(ms_searchparams& msp, MzIdentML& mzid)
    {
    ...
    void addAnalysisProtocol(ms_mascotresfile & file, MzIdentML& mzid)
    {
    ...
    void addSourceFile(ms_searchparams& p, MzIdentML& mzid)
    {
    ...
    void decryptMod(const string& mod, double mdelta,
                    ms_searchparams& p, MzIdentML& mzid)
    {
        SpectrumIdentificationProtocolPtr sip =
            getSpectrumIdentificationProtocol(mzid);
    ...
    void addModifications(ms_searchparams& p, MzIdentML& mzid)
    {
        vector<string> mods;
    ...
    void searchInformation(ms_mascotresfile & file, MzIdentML& mzid)
    {
    ...
    SpectrumIdentificationListPtr getSpectrumIdentificationList(MzIdentML& mzid)
    {
    ...
    SpectrumIdentificationResultPtr getSpectrumIdentificationResult(MzIdentML& mzid)
    {
    ...
    void proteinSummary(ms_mascotresfile& file, MzIdentML& mzid)
    {
    ...
    void inputData(ms_mascotresfile & file, MzIdentML& mzid)
    {
