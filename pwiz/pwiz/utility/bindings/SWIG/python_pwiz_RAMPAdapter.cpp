...
//
// Copyright 2011 Insilicos LLC All Rights Reserved
//
...
// actually this is just here to make it easier to create an object file
// with different compile switches

#include "pwiz_RAMPAdapter.cpp"
