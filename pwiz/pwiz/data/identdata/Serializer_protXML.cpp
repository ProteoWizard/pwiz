...
#define GET_TYPED_ATTR(T,name) T name; getAttribute(attributes, #name, name);
        ...
        else if (name == "protein") // nests in protein_group
        {
            ...
            pdh->set(pwiz::cv::MS_search_engine_specific_score_for_peptides, probability); // as in OpenMS
                              ...
                              stream_offset position)
    {
        ...
        {        
            ...
            if (!pe) {
                ...
                pe->set(MS_search_engine_specific_score_for_peptides, nsp_adjusted_probability);
