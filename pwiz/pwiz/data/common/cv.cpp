...
const TermInfo termInfos_[] =
{
    ...
    {MS_percolaror_PEP, "MS:1001493", "percolaror:PEP", "Posterior error probability.", false},
    ...
    {MS_, "MS:1001948", "", "PEAKS Node software for high throughput data analysis.", false},
    ...
    {MS_isobaric_label_quantification_analysis, "MS:1002009", "isobaric label quantification analysis", "Quantification analysis using an isobaric labeling workflow.", false},
    {MS_TMT_quantification_analysis, "MS:1002010", "TMT quantification analysis", "Quantification analysis using the Thermo Fisher tandem mass tag (TMT) labeling workflow.", false},
...
CVIDPair relationsIsA_[] =
{
    ...
    {MS_percolaror_PEP, MS_search_engine_specific_score_for_peptides},
    {MS_percolaror_PEP, MS_search_engine_specific_score},
    ...
    {MS_iTRAQ_quantitation_analysis, MS_isobaric_label_quantification_analysis},
    ...
    {MS_coefficient_of_variation, MS_mz5_file},
    {MS_signal_to_noise_ratio, MS_mz5_file},
    ...
    {MS_, MS_quantitation_software_name},
    {MS_, MS_analysis_software},
    {MS_, MS_data_processing_software},
    ...
    {MS_MS1_Label_based_raw_feature_quantitation, MS_quantitation_analysis_summary},
    {MS_MS1_Label_based_peptide_level_quantitation, MS_quantitation_analysis_summary},
    {MS_MS1_Label_based_protein_level_quantitation, MS_quantitation_analysis_summary},
    {MS_MS1_Label_based_proteinGroup_level_quantitation, MS_quantitation_analysis_summary},
    ...
    {MS_isobaric_label_quantification_analysis, MS_quantitation_analysis_summary},
    {MS_TMT_quantification_analysis, MS_quantitation_analysis_summary},
