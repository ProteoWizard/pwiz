...
const TermInfo termInfos_[] =
{
    ...
    {MS_m_z_Separation_Method, "MS:1000444", "m/z Separation Method", "m/z Separation Method.", false},
    {MS_sequential_m_z_separation_method, "MS:1000445", "sequential m/z separation method", "Sequential m/z separation method.", false},
    ...
    {MS_4800_Plus_MALDI_TOF_TOF, "MS:1000652", "4800 Plus MALDI TOF/TOF", "AB SCIEX or Applied Biosystems|MDS SCIEX 4800 Plus MALDI TOF-TOF Analyzer.", false},
    ...
    {MS_Cliquid, "MS:1000672", "Cliquid", "AB SCIEX Cliquid software for data analysis and quantitation.", false},
    ...
    {MS_laser_type, "MS:1000842", "laser type", "Type of laser used used for desorption purpose.", false},
    ...
    {MS_4000_QTRAP_OBSOLETE, "MS:1000870", "4000 QTRAP", "AB SCIEX or Applied Biosystems|MDS SCIEX QTRAP 4000.", true},
    ...
    {MS_SSRCalc, "MS:1000874", "SSRCalc", "Sequence Specific Retention Calculator esimates the retention time of peptides based on their sequence.", false},
    ...
    {MS_TripleTOF_5600, "MS:1000932", "TripleTOF 5600", "AB SCIEX TripleTOF 5600, a quadrupole - quadrupole - time-of-flight mass spectrometer.", false},
    ...
    {MS_peptide_identification_confidence_metric, "MS:1001092", "peptide identification confidence metric", "Peptide identification confidence metric for a peptide (p-value, Expect value, confidence, local FDR).", false},
    ...
    {MS_protein_group_subset_relationship, "MS:1001101", "protein group/subset relationship", "Branch containing protein group/subset relationships.", false},
    ...
    {MS_peptide_raw_area, "MS:1001130", "peptide raw area", "Peptide raw area.", false},
    ...
    {MS_Sequest_SelectAdvancedCV, "MS:1001145", "Sequest:SelectAdvancedCV", "Branch containing the CV terms for Sequest Select Advanced Input Parameters.", false},
    ...
    {MS_protein_identification_confidence_metric, "MS:1001198", "protein identification confidence metric", "Protein identification confidence metric (p-value, Expect value, confidence, local FDR).", false},
    ...
    {MS_add_others_OBSOLETE, "MS:1001326", "add_others", "", true},
    ...
    {MS_ASN_1, "MS:1001349", "ASN.1", "The sequence database was stored in the ASN.1 format.", false},
    ...
    {MS_greylag, "MS:1001461", "greylag", "Greylag identification software, see greylag.org.", false},
    ...
    {MS_TOF_TOF_5800, "MS:1001482", "TOF/TOF 5800", "AB SCIEX or Applied Biosystems|MDS Analytical Technologies AB SCIEX TOF/TOF 5800 Analyzer.", false},
    ...
    {MS_spectrum_from_database_integer_nativeID_format, "MS:1001526", "spectrum from database integer nativeID format", "databasekey=xsd:long.", false},
    ...
    {MS_spectrum_from_database_string_nativeID_format, "MS:1001532", "spectrum from database string nativeID format", "databasekey=xsd:string.", false},
    ...
    {MS_ProteomeDiscoverer_Minimum_Peak_Count, "MS:1001609", "ProteomeDiscoverer:Minimum Peak Count", "Minimum number of peaks in a tandem mass spectrum that is allowed to pass the filter and to be subjected to further processing in the workflow.", false},
    {MS_ProteomeDiscoverer_MS_Order_OBSOLETE, "MS:1001610", "ProteomeDiscoverer:MS Order", "Level of the mass spectrum (MS/MS=MS2 ... MS10).", true},
    ...
    {MS_ProteomeDiscoverer_Total_Intensity_Threshold, "MS:1001615", "ProteomeDiscoverer:Total Intensity Threshold", "Used to filter out tandem mass spectra that have a total intensity current(sum of the intensities of all peaks in a spectrum) below the specified value.", false},
    ...
    {MS_ProteomeDiscoverer_Non_Fragment_Filter_Remove_Precursor_Peak, "MS:1001628", "ProteomeDiscoverer:Non-Fragment Filter:Remove Precursor Peak", "Determines whether precursor artifact peaks from the MS/MS input spectra are removed.", false},
    ...
    {MS_ProteomeDiscoverer_Dynamic_Modifications, "MS:1001644", "ProteomeDiscoverer:Dynamic Modifications", "Determine dynamic post-translational modifications (PTMs).", false},
    {MS_ProteomeDiscoverer_Static_Modifications, "MS:1001645", "ProteomeDiscoverer:Static Modifications", "Static Modification to all occurrences of a named amino acid.", false},
    ...
    {MS_ProteomeDiscoverer_1__Dynamic_Modification, "MS:1001720", "ProteomeDiscoverer:1. Dynamic Modification", "Determine 1st dynamic post-translational modifications (PTMs).", false},
    {MS_ProteomeDiscoverer_2__Dynamic_Modification, "MS:1001721", "ProteomeDiscoverer:2. Dynamic Modification", "Determine 2nd dynamic post-translational modifications (PTMs).", false},
    {MS_ProteomeDiscoverer_3__Dynamic_Modification, "MS:1001722", "ProteomeDiscoverer:3. Dynamic Modification", "Determine 3rd dynamic post-translational modifications (PTMs).", false},
    {MS_ProteomeDiscoverer_4__Dynamic_Modification, "MS:1001723", "ProteomeDiscoverer:4. Dynamic Modification", "Determine 4th dynamic post-translational modifications (PTMs).", false},
    ...
    {MS_ACQUITY_UPLC, "MS:1001761", "ACQUITY UPLC", "Waters LC-system.", false},
    {MS_ACQUITY_UPLC_H_Class, "MS:1001762", "ACQUITY UPLC H-Class", "Waters LC-system.", false},
    {MS_ACQUITY_UPLC_H_Class_Bio, "MS:1001763", "ACQUITY UPLC H-Class Bio", "Waters LC-system.", false},
    {MS_ACQUITY_UPLC_I_Class, "MS:1001764", "ACQUITY UPLC I-Class", "Waters LC-system.", false},
    {MS_ACQUITY_UPLC_Systems_with_2D_Technology, "MS:1001765", "ACQUITY UPLC Systems with 2D Technology", "Waters LC-system.", false},
    {MS_nanoACQUITY_UPLC, "MS:1001766", "nanoACQUITY UPLC", "Waters LC-system.", false},
    {MS_nanoACQUITY_UPLC_System_with_Technology, "MS:1001767", "nanoACQUITY UPLC System with Technology", "Waters LC-system.", false},
    {MS_nanoACQUITY_UPLC_with_HDX_Technology, "MS:1001768", "nanoACQUITY UPLC with HDX Technology", "Waters LC-system.", false},
    {MS_TRIZAIC_UPLC_nanoTile, "MS:1001769", "TRIZAIC UPLC nanoTile", "Waters LC-system.", false},
    {MS_GCT_Premier, "MS:1001770", "GCT Premier", "Waters oa-ToF based.", false},
    {MS_MALDI_Synapt_G2_HDMS, "MS:1001771", "MALDI Synapt G2 HDMS", "Waters oa-ToF based.", false},
    {MS_MALDI_Synapt_G2_MS, "MS:1001772", "MALDI Synapt G2 MS", "Waters oa-ToF based.", false},
    {MS_MALDI_Synapt_G2_S_HDMS, "MS:1001773", "MALDI Synapt G2-S HDMS", "Waters oa-ToF based.", false},
    {MS_MALDI_Synapt_G2_S_MS, "MS:1001774", "MALDI Synapt G2-S MS", "Waters oa-ToF based.", false},
    {MS_MALDI_Synapt_HDMS, "MS:1001775", "MALDI Synapt HDMS", "Waters oa-ToF based.", false},
    {MS_MALDI_Synapt_MS, "MS:1001776", "MALDI Synapt MS", "Waters oa-ToF based.", false},
    {MS_Synapt_G2_HDMS, "MS:1001777", "Synapt G2 HDMS", "Waters oa-ToF based.", false},
    {MS_Synapt_G2_MS, "MS:1001778", "Synapt G2 MS", "Waters oa-ToF based.", false},
    {MS_Synapt_G2_S_HDMS, "MS:1001779", "Synapt G2-S HDMS", "Waters oa-ToF based.", false},
    {MS_Synapt_G2_S_MS, "MS:1001780", "Synapt G2-S MS", "Waters oa-ToF based.", false},
    {MS_Synapt_HDMS, "MS:1001781", "Synapt HDMS", "Waters oa-ToF based.", false},
    {MS_Synapt_MS, "MS:1001782", "Synapt MS", "Waters oa-ToF based.", false},
    {MS_Xevo_G2_Q_Tof, "MS:1001783", "Xevo G2 Q-Tof", "Waters oa-ToF based.", false},
    {MS_Xevo_G2_Tof, "MS:1001784", "Xevo G2 Tof", "Waters oa-ToF based.", false},
    {MS_Xevo_Q_Tof, "MS:1001785", "Xevo Q-Tof", "Waters oa-ToF based.", false},
    {MS_3100, "MS:1001786", "3100", "Waters quadrupole based.", false},
    {MS_Acquity_SQD, "MS:1001787", "Acquity SQD", "Waters quadrupole based.", false},
    {MS_Acquity_TQD, "MS:1001788", "Acquity TQD", "Waters quadrupole based.", false},
    {MS_Quattro_micro_GC, "MS:1001789", "Quattro micro GC", "Waters quadrupole based.", false},
    {MS_Xevo_TQ_MS, "MS:1001790", "Xevo TQ MS", "Waters quadrupole based.", false},
    {MS_Xevo_TQD, "MS:1001791", "Xevo TQD", "Waters quadrupole based.", false},
    {MS_Xevo_TQ_S, "MS:1001792", "Xevo TQ-S", "Waters quadrupole based.", false},
    ...
    {MS_Empower, "MS:1001795", "Empower", "Waters software for liquid chromatography acquisition, processing, data analysis and data management.", false},
    {MS_Unify, "MS:1001796", "Unify", "Waters software for liquid chromatography and mass spectrometry acquisition, processing, data analysis and data management.", false},
    {MS_travelling_wave_ion_mobility_mass_spectrometer, "MS:1001797", "travelling wave ion mobility mass spectrometer", "An ion mobility mass spectrometry technique based on the superimposition of travelling voltage waves on a radially-confining RF voltage in a gas-filled, stacked-ring ion guide.", false},
    ...
    {MS_quantification_datatype, "MS:1001805", "quantification datatype", "The data type of the value reported in a QuantLayer for a feature, matchedfeature, peptide, protein, protein group.", false},
    ...
    {MS_StudyVariable_attribute, "MS:1001807", "StudyVariable attribute", "Attribute describing a study variable.", false},
    ...
    {MS_biological_replicate, "MS:1001809", "biological replicate", "The study variable is 'biological replicate'. This means, the run was generated from another individuum or sample.", false},
    ...
    {MS_RawFile_attribute, "MS:1001817", "RawFile attribute", "Attribute describing a raw file.", false},
    ...
    {MS_two_sample_run, "MS:1001819", "two sample run", "The raw file contains the run of two samples (e.g. SILAC, metabolic labeling).", false},
    ...
    {MS_RawFilesGroup_attribute, "MS:1001823", "RawFilesGroup attribute", "Attribute describing, how raw files build a raw file group.", false},
    ...
    {MS_FeatureList_attribute, "MS:1001825", "FeatureList attribute", "Attribute describing a FeatureList.", false},
    ...
    {MS_mass_trace_reporting__polygons, "MS:1001827", "mass trace reporting: polygons", "The mass trace of the features of this feature list specifies polygons. Each mass trace has the syntax (RT_1,MZ_1,RT_2,MZ_2,...,RT_i,MZ_i,...,RT_n,MZ_n), where the line (RT_n,MZ_n)->(RT_1,MZ_1) is implicite.", false},
    {MS_Feature_attribute, "MS:1001828", "Feature attribute", "Attribute describing a Feature.", false},
    {MS_SRM_transition_ID, "MS:1001829", "SRM transition ID", "SRM transition ID.", false},
    ...
    {MS_quantitation_software_comment___customizations, "MS:1001832", "quantitation software comment / customizations", "Quantitation software comment or any customizations to the default setup of the software.", false},
    ...
    {MS_spectral_counting_quantitation_analysis, "MS:1001836", "spectral counting quantitation analysis", "Spectral counting workflow (number of identified MS/MS spectra as approximation of peptide / protein quant).", false},
    {MS_iTRAQ_quantitation_analysis, "MS:1001837", "iTRAQ quantitation analysis", "Quantification analysis using the AB SCIEX iTRAQ isobaric labeling workflow, wherein 2-8 reporter ions are measured in MS/MS spectra near 114 m/z.", false},
    {MS_SRM_quantitation_analysis, "MS:1001838", "SRM quantitation analysis", "Selected Reaction Monitoring workflow (XIC quant. of precursor / fragment mass pair).", false},
    ...
    {MS_peptide_PSM_count, "MS:1001842", "peptide PSM count", "The number of MS/MS spectra identified for this peptide in spectral counting.", false},
    ...
    {MS_reporter_ion_intensity, "MS:1001847", "reporter ion intensity", "Intensity of MS/MS reporter ion (e.g. iTraq).", false},
    {MS_simple_ratio_of_two_value, "MS:1001848", "simple ratio of two value", "Simple ratio of two values (enumerator and denominator).", false},
    {MS_sum_of_MatchedFeature_values, "MS:1001849", "sum of MatchedFeature values", "Peptide quantification value calculated as sum of MatchedFeature quantification values.", false},
    ...
    {MS_reporter_ion_raw_value, "MS:1001856", "reporter ion raw value", "Intensity (or area) of MS/MS reporter ion (e.g. iTraq).", false},
    {MS_reporter_ion_normalized_value, "MS:1001857", "reporter ion normalized value", "Normalized value of MS/MS reporter ion (e.g. iTraq).", false},
    ...
    {MS_q_value_for_peptides, "MS:1001868", "q-value for peptides", "Peptide identification confidence metric q-value.", false},
    {MS_q_value_for_proteins, "MS:1001869", "q-value for proteins", "Protein identification confidence metric q-value.", false},
    {MS_p_value_for_peptides, "MS:1001870", "p-value for peptides", "Peptide identification confidence metric p-value.", false},
    {MS_p_value_for_proteins, "MS:1001871", "p-value for proteins", "Protein identification confidence metric p-value.", false},
    {MS_E_value_for_peptides, "MS:1001872", "E-value for peptides", "Peptide identification confidence metric E-value.", false},
    {MS_E_value_for_proteins, "MS:1001873", "E-value for proteins", "Protein identification confidence metric E-value.", false},
    {MS_FDRScore, "MS:1001874", "FDRScore", "Quality measurement score.", false},
    ...
    {MS_mz5_file, "MS:1001881", "mz5 file", "mz5 file format, modeled after mzML.", false},
    ...
    {MS_MaxQuant_MS_MS_count, "MS:1001904", "MaxQuant:MS/MS count", "The data type MS/MS count produced by MaxQuant.", false},
    ...
    {MS_Digital_Object_Identifier__DOI_, "MS:1001922", "Digital Object Identifier (DOI)", "DOI unique identifier.", false},
    ...
    {MS______ALIV_____P_, "MS:1001957", "(?<=[ALIV])(?!P)", "", false},
    {MS______HKR_P____P_, "MS:1001958", "(?<=[HKR]P)(?!P)", "", false},
    {MS_______E_E_, "MS:1001959", "(?<=[^E]E)", "", false},
    {MS_____W_, "MS:1001960", "(?<=W)", "", false},
    ...
    {MS_product_ion_drift_time, "MS:1001967", "product ion drift time", "The ion drift time of an MS2 product ion.", false},
    {MS_PTM_localization_score, "MS:1001968", "PTM localization score", "A score that assign confidence to the localization of an amino acid modification on a peptide sequence.", false},
    {MS_ProteomeDiscoverer_phosphoRS_score, "MS:1001969", "ProteomeDiscoverer:phosphoRS score", "Peptide score based on the cumulative binomial probability that the observed match is a random event.", false},
    {MS_ProteomeDiscoverer_phosphoRS_sequence_probability, "MS:1001970", "ProteomeDiscoverer:phosphoRS sequence probability", "Probability that the respective isoform is correct.", false},
    {MS_ProteomeDiscoverer_phosphoRS_site_probability, "MS:1001971", "ProteomeDiscoverer:phosphoRS site probability", "Estimate of the probability that the respective site is truly phosphorylated.", false},
    ...
    {MS_Ascore, "MS:1001984", "Ascore", "Ascore software.", false},
    {MS_Ascore_Ascore, "MS:1001985", "Ascore:Ascore", "The Ascore score value from Ascore software.", false},
    ...
    {MS_isobaric_label_quantitation_analysis, "MS:1002009", "isobaric label quantitation analysis", "Quantitation analysis using an isobaric labeling workflow.", false},
    {MS_TMT_quantitation_analysis, "MS:1002010", "TMT quantitation analysis", "Quantitation analysis using the Thermo Fisher tandem mass tag (TMT) labeling workflow.", false},
    ...
    {MS_original_nucleic_acid_sequence, "MS:1002029", "original nucleic acid sequence", "Original nucleic acid sequence before a nucleic acid base modification.", false},
    {MS_modified_nucleic_acid_sequence, "MS:1002030", "modified nucleic acid sequence", "Modified nucleic acid sequence after a nucleic acid base modification.", false},
    ...
    {UO_derived_unit_OBSOLETE, "UO:0000046", "derived unit", "A unit which is derived from base units.", true},
...
CVIDPair relationsIsA_[] =
{
    ...
    {MS_multiple_stage_mass_spectrometry, MS_sequential_m_z_separation_method},
    ...
    {MS_paul_ion_trap_OBSOLETE, MS_purgatory},
    ...
    {MS_2E_Mass_Spectrum, MS_sequential_m_z_separation_method},
    ...
    {MS_MS_MS_in_Time, MS_sequential_m_z_separation_method},
    {MS_MS_MS_in_Space, MS_sequential_m_z_separation_method},
    {MS_neutral_loss, MS_sequential_m_z_separation_method},
    ...
    {MS_contact_organization, MS_contact_attribute},
    ...
    {MS_4800_Plus_MALDI_TOF_TOF, MS_AB_SCIEX_instrument_model},
    ...
    {MS_Cliquid, MS_AB_SCIEX_software},
    ...
    {MS_4000_QTRAP_OBSOLETE, MS_AB_SCIEX_instrument_model},
    ...
    {MS_QTRAP_5500, MS_AB_SCIEX_instrument_model},
    {MS_TripleTOF_5600, MS_AB_SCIEX_instrument_model},
    ...
    {MS_peptide_identification_confidence_metric, MS_peptide_result_details},
    ...
    {MS_manual_validation, MS_peptide_identification_confidence_metric},
    {MS_manual_validation, MS_protein_identification_confidence_metric},
    ...
    {MS_peptide_raw_area, MS_quantification_datatype},
    {MS_error_on_peptide_area, MS_quantification_datatype},
    {MS_peptide_ratio, MS_quantification_datatype},
    {MS_error_on_peptide_ratio, MS_quantification_datatype},
    {MS_protein_ratio, MS_quantification_datatype},
    {MS_error_on_protein_ratio, MS_quantification_datatype},
    {MS_p_value__protein_diff_from_1_randomly_, MS_quantification_datatype},
    ...
    {MS_Paragon_expression_change_p_value, MS_p_value_for_proteins},
    ...
    {MS_p_value_OBSOLETE, MS_peptide_identification_confidence_metric},
    ...
    {MS_protein_identification_confidence_metric, MS_protein_result_details},
    ...
    {MS_local_FDR, MS_peptide_identification_confidence_metric},
    {MS_local_FDR, MS_protein_identification_confidence_metric},
    ...
    {MS_Phenyx_PepPvalue, MS_p_value_for_peptides},
    ...
    {MS_TOF_TOF_5800, MS_AB_SCIEX_instrument_model},
    ...
    {MS_percolator_Q_value, MS_q_value_for_peptides},
    {MS_percolator_score, MS_search_engine_specific_score_for_peptides},
    {MS_percolator_score, MS_search_engine_specific_score},
    {MS_percolator_PEP, MS_search_engine_specific_score_for_peptides},
    {MS_percolator_PEP, MS_search_engine_specific_score},
    ...
    {MS_Scaffold_Protein_Probability, MS_search_engine_specific_score},
    ...
    {MS_anchor_protein, MS_protein_group_subset_relationship},
    {MS_family_member_protein, MS_protein_group_subset_relationship},
    {MS_group_member_with_undefined_relationship_OR_ortholog_protein, MS_protein_group_subset_relationship},
    {MS_sequence_same_set_protein, MS_protein_group_subset_relationship},
    {MS_spectrum_same_set_protein, MS_protein_group_subset_relationship},
    {MS_sequence_sub_set_protein, MS_protein_group_subset_relationship},
    {MS_spectrum_sub_set_protein, MS_protein_group_subset_relationship},
    {MS_sequence_subsumable_protein, MS_protein_group_subset_relationship},
    {MS_spectrum_subsumable_protein, MS_protein_group_subset_relationship},
    {MS_Protein_Inference_Confidence_Category, MS_protein_identification_confidence_metric},
    {MS_ProteomeDiscoverer_Spectrum_Files_Raw_File_names_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SRF_File_Selector_SRF_File_Path_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Ionization_Source_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Activation_Type_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Lower_RT_Limit, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mass_Analyzer_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Max_Precursor_Mass, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Min_Precursor_Mass, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Minimum_Peak_Count, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_MS_Order_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Polarity_Mode_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Precursor_Selection, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SN_Threshold, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Scan_Type_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Total_Intensity_Threshold, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Unrecognized_Activation_Type_Replacements, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Unrecognized_Charge_Replacements, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Unrecognized_Mass_Analyzer_Replacements, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Unrecognized_MS_Order_Replacements, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Unrecognized_Polarity_Replacements, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Upper_RT_Limit, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Non_Fragment_Filter_Mass_Window_Offset, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Non_Fragment_Filter_Maximum_Neutral_Loss_Mass, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Non_Fragment_Filter_Remove_Charge_Reduced_Precursor, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Non_Fragment_Filter_Remove_Neutral_Loss_Peaks, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Non_Fragment_Filter_Remove_Only_Known_Masses, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Non_Fragment_Filter_Remove_Precursor_Overtones, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Non_Fragment_Filter_Remove_Precursor_Peak, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Grouper_Allow_Mass_Analyzer_Mismatch, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Grouper_Allow_MS_Order_Mismatch, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Grouper_Max_RT_Difference_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Grouper_Precursor_Mass_Criterion, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Xtract_Highest_Charge, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Xtract_Highest_MZ_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Xtract_Lowest_Charge, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Xtract_Lowest_MZ_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Xtract_Monoisotopic_Mass_Only, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Xtract_Overlapping_Remainder, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Xtract_Required_Fitting_Accuracy, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Xtract_Resolution_At_400, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Lowest_Charge_State, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Highest_Charge_State, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Score_Filter_Let_Pass_Above_Scores, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Dynamic_Modifications, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Static_Modifications, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Decoy_Search_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Error_tolerant_Search, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Max_MGF_File_Size, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Mascot_Server_URL, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Number_of_attempts_to_submit_the_search, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_X_Static_Modification, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_User_Name_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Time_interval_between_attempts_to_submit_a_search, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Enzyme_Name_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Fragment_Mass_Tolerance_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_Mascot_Instrument, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Maximum_Missed_Cleavage_Sites, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Peptide_CutOff_Score, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Precursor_Mass_Tolerance_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Protein_CutOff_Score, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Protein_Database_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Protein_Relevance_Factor, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Target_FDR_Relaxed, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Target_FDR_Strict, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Taxonomy_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Use_Average_Precursor_Mass_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_Mascot_use_MudPIT_scoring_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Absolute_XCorr_Threshold, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Calculate_Probability_Score, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_CTerminal_Modification, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Fragment_Ion_Cutoff_Percentage, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Max_Identical_Modifications_Per_Peptide, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Max_Modifications_Per_Peptide, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Maximum_Peptides_Considered, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Maximum_Peptides_Output, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Maximum_Protein_References_Per_Peptide, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_NTerminal_Modification, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Peptide_CTerminus, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Peptide_NTerminus, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Peptide_Relevance_Factor, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Protein_Relevance_Threshold, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Search_Against_Decoy_Database_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Use_Average_Fragment_Masses, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Use_Neutral_Loss_a_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Use_Neutral_Loss_b_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Use_Neutral_Loss_y_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Use_Neutral_Loss_z_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Weight_of_a_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Weight_of_b_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Weight_of_c_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Weight_of_d_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Weight_of_v_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Weight_of_w_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Weight_of_x_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Weight_of_y_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Weight_of_z_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_ZCore_Protein_Score_Cutoff, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Reporter_Ions_Quantizer_Integration_Method, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Reporter_Ions_Quantizer_Integration_Window_Tolerance, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Reporter_Ions_Quantizer_Quantitation_Method, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Exporter_Export_Format_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Exporter_File_name, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Search_Modifications_Only_For_Identified_Proteins, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Std_High_Confidence_XCorr_Charge1, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Std_High_Confidence_XCorr_Charge2, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Std_High_Confidence_XCorr_Charge3, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Std_High_Confidence_XCorr_Charge4, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Std_Medium_Confidence_XCorr_Charge1, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Std_Medium_Confidence_XCorr_Charge2, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Std_Medium_Confidence_XCorr_Charge3, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_Std_Medium_Confidence_XCorr_Charge4, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_FT_High_Confidence_XCorr_Charge1, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_FT_High_Confidence_XCorr_Charge2, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_FT_High_Confidence_XCorr_Charge3, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_FT_High_Confidence_XCorr_Charge4, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_FT_Medium_Confidence_XCorr_Charge1, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_FT_Medium_Confidence_XCorr_Charge2, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_FT_Medium_Confidence_XCorr_Charge3, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_SEQUEST_FT_Medium_Confidence_XCorr_Charge4, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_1__Dynamic_Modification, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_2__Dynamic_Modification, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_3__Dynamic_Modification, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_4__Dynamic_Modification, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Static_Modification_for_X, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Initial_minimal_peptide_probability, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Minimal_peptide_probability, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Minimal_peptide_weight, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Number_of_input1_spectra, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Number_of_input2_spectra, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Number_of_input3_spectra, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Number_of_input4_spectra, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Number_of_input5_spectra, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Number_of_predicted_correct_proteins, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Organism_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Reference_Database_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Residue_substitution_list, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Source_file_extension_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Source_Files_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Source_Files_old_OBSOLETE, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_WinCyg_reference_database, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_WinCyg_source_files, MS_search_engine_specific_input_parameter},
    {MS_LTQ_Orbitrap_Velos, MS_Thermo_Scientific_instrument_model},
    {MS_ProteomeDiscoverer_Mascot_Weight_of_A_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Weight_of_B_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Weight_of_C_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Weight_of_D_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Weight_of_V_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Weight_of_W_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Weight_of_X_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Weight_of_Y_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Weight_of_Z_Ions, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_Use_New_Precursor_Reevaluation, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Spectrum_Selector_SN_Threshold_FTonly, MS_search_engine_specific_input_parameter},
    {MS_ProteomeDiscoverer_Mascot_Please_Do_not_Touch_this, MS_search_engine_specific_input_parameter},
    ...
    {MS_Mascot_SigThresholdType, MS_search_engine_specific_input_parameter},
    {MS_Mascot_ProteinGrouping, MS_search_engine_specific_input_parameter},
    {MS_Percolator_features, MS_search_engine_specific_input_parameter},
    ...
    {MS_nanoACQUITY_UPLC_System_with_Technology, MS_Waters_instrument_model},
    ...
    {MS_Mascot_PreferredTaxonomy, MS_search_engine_specific_input_parameter},
    ...
    {MS_travelling_wave_ion_mobility_mass_spectrometer, MS_ion_mobility_spectrometry},
    ...
    {MS_StudyVariable_attribute, MS_quantification_object_attribute},
    {MS_technical_replicate, MS_StudyVariable_attribute},
    {MS_biological_replicate, MS_StudyVariable_attribute},
    {MS_experimental_condition__case_, MS_StudyVariable_attribute},
    {MS_experimental_condition__control_, MS_StudyVariable_attribute},
    {MS_experimental_condition__disease_, MS_StudyVariable_attribute},
    {MS_experimental_condition__healthy_, MS_StudyVariable_attribute},
    {MS_generic_experimental_condition, MS_StudyVariable_attribute},
    {MS_time_series__time_point_X, MS_StudyVariable_attribute},
    {MS_dilution_series__concentration_X, MS_StudyVariable_attribute},
    {MS_RawFile_attribute, MS_quantification_object_attribute},
    {MS_one_sample_run, MS_RawFile_attribute},
    {MS_two_sample_run, MS_RawFile_attribute},
    {MS_three_sample_run, MS_RawFile_attribute},
    {MS_four_sample_run, MS_RawFile_attribute},
    {MS_eight_sample_run, MS_RawFile_attribute},
    {MS_RawFilesGroup_attribute, MS_quantification_object_attribute},
    {MS_merge_of_runs_of_1D_gel_bands, MS_RawFilesGroup_attribute},
    {MS_FeatureList_attribute, MS_quantification_object_attribute},
    {MS_mass_trace_reporting__rectangles, MS_FeatureList_attribute},
    {MS_mass_trace_reporting__polygons, MS_FeatureList_attribute},
    ...
    {MS_quantitation_software_comment___customizations, MS_quantification_information},
    ...
    {MS_peptide_PSM_count, MS_quantification_datatype},
    {MS_MS1_feature_maximum_intensity, MS_quantification_datatype},
    {MS_MS1_feature_area, MS_quantification_datatype},
    ...
    {MS_simple_ratio_of_two_value, MS_quantification_datatype},
    {MS_sum_of_MatchedFeature_values, MS_quantification_datatype},
    {MS_normalized_peptide_value, MS_quantification_datatype},
    {MS_protein_value__sum_of_peptide_values, MS_quantification_datatype},
    {MS_normalized_protein_value, MS_quantification_datatype},
    {MS_max_fold_change, MS_quantification_datatype},
    {MS_ANOVA_p_value, MS_quantification_datatype},
    {MS_t_test_p_value, MS_quantification_datatype},
    ...
    {MS_protein_value__mean_of_peptide_ratios, MS_quantification_datatype},
    ...
    {MS_q_value_for_peptides, MS_peptide_identification_confidence_metric},
    {MS_q_value_for_proteins, MS_protein_identification_confidence_metric},
    {MS_p_value_for_peptides, MS_peptide_identification_confidence_metric},
    {MS_p_value_for_proteins, MS_protein_identification_confidence_metric},
    {MS_E_value_for_peptides, MS_peptide_identification_confidence_metric},
    {MS_E_value_for_proteins, MS_protein_identification_confidence_metric},
    {MS_FDRScore, MS_spectrum_identification_result_details},
    ...
    {MS_MALDI_Solutions_Microbial_Identification, MS_acquisition_software},
    {MS_MALDI_Solutions_Microbial_Identification, MS_analysis_software},
    {MS_MALDI_Solutions_Microbial_Identification, MS_data_processing_software},
    ...
    {MS_mz5_file, MS_mass_spectrometer_file_format},
    ...
    {MS_SQID_score, MS_search_engine_specific_score_for_peptides},
    {MS_SQID_score, MS_search_engine_specific_score},
    {MS_SQID_deltaScore, MS_search_engine_specific_score_for_peptides},
    {MS_SQID_deltaScore, MS_search_engine_specific_score},
    {MS_SQID_protein_score, MS_single_protein_result_details},
    {MS_SQID_protein_score, MS_search_engine_specific_score},
    {MS_Progenesis_protein_normalised_abundance, MS_quantification_datatype},
    {MS_Progenesis_peptide_normalised_abundance, MS_quantification_datatype},
    {MS_Progenesis_protein_raw_abundance, MS_quantification_datatype},
    {MS_Progenesis_peptide_raw_abundance, MS_quantification_datatype},
    {MS_Progenesis_confidence_score, MS_quantification_datatype},
    {MS_Progenesis_peptide_count, MS_quantification_datatype},
    {MS_Progenesis_feature_intensity, MS_quantification_datatype},
    {MS_MaxQuant_peptide_counts__unique_, MS_quantification_datatype},
    {MS_MaxQuant_peptide_counts__all_, MS_quantification_datatype},
    {MS_MaxQuant_peptide_counts__razor_unique_, MS_quantification_datatype},
    {MS_MaxQuant_sequence_length, MS_quantification_datatype},
    {MS_MaxQuant_PEP, MS_quantification_datatype},
    {MS_MaxQuant_LFQ_intensity, MS_quantification_datatype},
    {MS_MaxQuant_feature_intensity, MS_quantification_datatype},
    {MS_MaxQuant_MS_MS_count, MS_quantification_datatype},
    {MS_emPAI_value, MS_quantification_datatype},
    {MS_APEX_value, MS_quantification_datatype},
    ...
    {MS_external_reference_keyword, MS_external_reference_identifier},
    ...
    {MS_PEAKS_peptideScore, MS_search_engine_specific_score_for_peptides},
    {MS_PEAKS_peptideScore, MS_search_engine_specific_score},
    {MS_PEAKS_proteinScore, MS_single_protein_result_details},
    {MS_PEAKS_proteinScore, MS_search_engine_specific_score},
    {MS_ZCore_probScore, MS_search_engine_specific_score_for_peptides},
    {MS_ZCore_probScore, MS_search_engine_specific_score},
    ...
    {MS_Mascot_C13_counts, MS_search_engine_specific_input_parameter},
    {MS_ProteinExtractor_Weighting, MS_search_engine_specific_input_parameter},
    {MS_ProteinScape_second_round_Mascot, MS_search_engine_specific_input_parameter},
    {MS_ProteinScape_second_round_Phenyx, MS_search_engine_specific_input_parameter},
    {MS_product_ion_mobility, MS_fragmentation_information},
    {MS_PTM_localization_score, MS_search_engine_specific_score_for_peptides},
    {MS_ProteomeDiscoverer_phosphoRS_score, MS_PTM_localization_score},
    {MS_ProteomeDiscoverer_phosphoRS_sequence_probability, MS_PTM_localization_score},
    {MS_ProteomeDiscoverer_phosphoRS_site_probability, MS_PTM_localization_score},
    {MS_PTM_scoring_algorithm_version, MS_peptide_modification_details},
    {MS_DeBunker, MS_analysis_software},
    {MS_DeBunker_score, MS_search_engine_specific_score},
    {MS_DeBunker_score, MS_search_engine_specific_score_for_peptides},
    {MS_DeBunker_score, MS_spectrum_identification_result_details},
    {MS_DeBunker_score, MS_PTM_localization_score},
    ...
    {MS_MSQuant_PTM_score, MS_search_engine_specific_score},
    {MS_MSQuant_PTM_score, MS_search_engine_specific_score_for_peptides},
    {MS_MSQuant_PTM_score, MS_spectrum_identification_result_details},
    {MS_MSQuant_PTM_score, MS_PTM_localization_score},
    {MS_MaxQuant_PTM_Score, MS_search_engine_specific_score},
    {MS_MaxQuant_PTM_Score, MS_search_engine_specific_score_for_peptides},
    {MS_MaxQuant_PTM_Score, MS_spectrum_identification_result_details},
    {MS_MaxQuant_PTM_Score, MS_PTM_localization_score},
    {MS_MaxQuant_Phospho__STY__Probabilities, MS_search_engine_specific_score},
    {MS_MaxQuant_Phospho__STY__Probabilities, MS_search_engine_specific_score_for_peptides},
    {MS_MaxQuant_Phospho__STY__Probabilities, MS_spectrum_identification_result_details},
    {MS_MaxQuant_Phospho__STY__Probabilities, MS_PTM_localization_score},
    {MS_MaxQuant_Phospho__STY__Score_Diffs, MS_search_engine_specific_score},
    {MS_MaxQuant_Phospho__STY__Score_Diffs, MS_search_engine_specific_score_for_peptides},
    {MS_MaxQuant_Phospho__STY__Score_Diffs, MS_spectrum_identification_result_details},
    {MS_MaxQuant_Phospho__STY__Score_Diffs, MS_PTM_localization_score},
    {MS_MaxQuant_P_site_localization_probability, MS_search_engine_specific_score},
    {MS_MaxQuant_P_site_localization_probability, MS_search_engine_specific_score_for_peptides},
    {MS_MaxQuant_P_site_localization_probability, MS_spectrum_identification_result_details},
    {MS_MaxQuant_P_site_localization_probability, MS_PTM_localization_score},
    {MS_MaxQuant_PTM_Delta_Score, MS_search_engine_specific_score},
    {MS_MaxQuant_PTM_Delta_Score, MS_search_engine_specific_score_for_peptides},
    {MS_MaxQuant_PTM_Delta_Score, MS_spectrum_identification_result_details},
    {MS_MaxQuant_PTM_Delta_Score, MS_PTM_localization_score},
    {MS_Ascore, MS_analysis_software},
    {MS_Ascore_Ascore, MS_search_engine_specific_score},
    {MS_Ascore_Ascore, MS_search_engine_specific_score_for_peptides},
    {MS_Ascore_Ascore, MS_spectrum_identification_result_details},
    {MS_Ascore_Ascore, MS_PTM_localization_score},
    {MS_H_Score, MS_PTM_localization_score},
    ...
    {MS_TMT_quantitation_analysis, MS_quantitation_analysis_summary},
    {MS_desorption_electrospray_ionization, MS_atmospheric_pressure_ionization},
    {MS_Mascot_PTM_site_assignment_confidence, MS_search_engine_specific_score},
    {MS_Mascot_PTM_site_assignment_confidence, MS_search_engine_specific_score_for_peptides},
    {MS_Mascot_PTM_site_assignment_confidence, MS_spectrum_identification_result_details},
    {MS_Mascot_PTM_site_assignment_confidence, MS_PTM_localization_score},
    ...
    {MS_unlabeled_sample, MS_sample_attribute},
    ...
    {MS_ProteinProspector_score, MS_search_engine_specific_score_for_peptides},
    {MS_ProteinProspector_score, MS_search_engine_specific_score},
    {MS_ProteinProspector_expectation_value, MS_search_engine_specific_score_for_peptides},
    {MS_ProteinProspector_expectation_value, MS_search_engine_specific_score},
    {MS_native_source_path, MS_spectrum_generation_information},
    {MS_MS_GF, MS_analysis_software},
    {MS_MS_GF_, MS_analysis_software},
    {MS_MS_GF_RawScore, MS_search_engine_specific_score_for_peptides},
    {MS_MS_GF_RawScore, MS_search_engine_specific_score},
    {MS_MS_GF_DeNovoScore, MS_search_engine_specific_score},
    {MS_MS_GF_Energy, MS_search_engine_specific_score_for_peptides},
    {MS_MS_GF_Energy, MS_search_engine_specific_score},
    {MS_MS_GF_SpecEValue, MS_search_engine_specific_score_for_peptides},
    {MS_MS_GF_SpecEValue, MS_search_engine_specific_score},
    {MS_MS_GF_SpecEValue, MS_E_value_for_peptides},
    {MS_MS_GF_EValue, MS_search_engine_specific_score_for_peptides},
    {MS_MS_GF_EValue, MS_search_engine_specific_score},
    {MS_MS_GF_EValue, MS_E_value_for_peptides},
    {MS_MS_GF_QValue, MS_search_engine_specific_score_for_peptides},
    {MS_MS_GF_QValue, MS_search_engine_specific_score},
    {MS_MS_GF_QValue, MS_q_value_for_peptides},
    {MS_MS_GF_PepQValue, MS_search_engine_specific_score_for_peptides},
    {MS_MS_GF_PepQValue, MS_search_engine_specific_score},
    {MS_MS_GF_PepQValue, MS_q_value_for_peptides},
    {MS_MS_GF_PEP, MS_search_engine_specific_score_for_peptides},
    {MS_MS_GF_PEP, MS_search_engine_specific_score},
    {UO_length_unit, UO_unit},
    {UO_mass_unit, UO_unit},
    {UO_time_unit, UO_unit},
    {UO_electric_current_unit, UO_unit},
    {UO_temperature_unit, UO_unit},
    {UO_substance_unit, UO_unit},
    {UO_luminous_intensity_unit, UO_light_unit},
    {UO_meter, UO_length_unit},
    {UO_meter, UO_base_unit},
    {UO_kilogram, UO_mass_unit},
    {UO_kilogram, UO_base_unit},
    {UO_second, UO_time_unit},
    {UO_second, UO_base_unit},
    {UO_ampere, UO_electric_current_unit},
    {UO_ampere, UO_base_unit},
    {UO_kelvin, UO_temperature_unit},
    {UO_kelvin, UO_base_unit},
    {UO_mole, UO_substance_unit},
    {UO_mole, UO_base_unit},
    {UO_candela, UO_luminous_intensity_unit},
    {UO_candela, UO_base_unit},
    ...
    {UO_degree_celsius, UO_temperature_unit},
    {UO_millisecond, UO_time_unit},
    {UO_microsecond, UO_time_unit},
    {UO_picosecond, UO_time_unit},
    {UO_minute, UO_time_unit},
    {UO_hour, UO_time_unit},
    {UO_day, UO_time_unit},
    {UO_week, UO_time_unit},
    {UO_month, UO_time_unit},
    ...
    {UO_area_unit, UO_unit},
    {UO_acceleration_unit, UO_unit},
    {UO_angular_velocity_unit, UO_unit},
    {UO_angular_acceleration_unit, UO_unit},
    {UO_concentration_unit, UO_unit},
    {UO_mass_density_unit, UO_density_unit},
    {UO_luminance_unit, UO_light_unit},
    {UO_area_density_unit, UO_density_unit},
    {UO_molar_mass_unit, UO_mass_unit},
    {UO_molar_volume_unit, UO_volume_unit},
    {UO_momentum_unit, UO_unit},
    {UO_rotational_frequency_unit, UO_frequency_unit},
    {UO_specific_volume_unit, UO_volume_unit},
    {UO_speed_velocity_unit, UO_unit},
    ...
    {UO_frequency_unit, UO_unit},
    {UO_hertz, UO_frequency_unit},
    {UO_force_unit, UO_unit},
    {UO_newton, UO_force_unit},
    {UO_pressure_unit, UO_unit},
    {UO_pascal, UO_pressure_unit},
    {UO_energy_unit, UO_unit},
    {UO_joule, UO_energy_unit},
    {UO_power_unit, UO_unit},
    ...
    {UO_catalytic_activity_unit, UO_unit},
    {UO_katal, UO_catalytic_activity_unit},
    {UO_angle_unit, UO_unit},
    ...
    {UO_parts_per_notation_unit, UO_dimensionless_unit},
    {UO_parts_per_hundred, UO_parts_per_notation_unit},
    {UO_parts_per_thousand, UO_parts_per_notation_unit},
    {UO_parts_per_million, UO_parts_per_notation_unit},
    {UO_parts_per_billion, UO_parts_per_notation_unit},
    {UO_parts_per_trillion, UO_parts_per_notation_unit},
    {UO_parts_per_quadrillion, UO_parts_per_notation_unit},
    ...
    {UO_degree_fahrenheit, UO_temperature_unit},
    ...
    {UO_electric_potential_difference_unit, UO_unit},
    {UO_volt, UO_electric_potential_difference_unit},
    {UO_electric_charge, UO_unit},
    ...
    {UO_millivolt, UO_electric_potential_difference_unit},
    {UO_kilovolt, UO_electric_potential_difference_unit},
    {UO_microvolt, UO_electric_potential_difference_unit},
    {UO_nanovolt, UO_electric_potential_difference_unit},
    {UO_picovolt, UO_electric_potential_difference_unit},
    {UO_megavolt, UO_electric_potential_difference_unit},
    {UO_surface_tension_unit, UO_unit},
    {UO_newton_per_meter, UO_surface_tension_unit},
    {UO_dyne_per_cm, UO_surface_tension_unit},
    {UO_viscosity_unit, UO_unit},
    {UO_pascal_second, UO_viscosity_unit},
    {UO_poise, UO_viscosity_unit},
    {UO_decibel, UO_ratio},
    {UO_effective_dose_unit, UO_radiation_unit},
    {UO_conduction_unit, UO_unit},
    ...
    {UO_electric_field_strength_unit, UO_unit},
    {UO_volt_per_meter, UO_electric_field_strength_unit},
    {UO_absorbance_unit, UO_dimensionless_unit},
    {UO_volumetric_flow_rate_unit, UO_unit},
    {UO_microliters_per_minute, UO_volumetric_flow_rate_unit},
    {UO_millimetres_of_mercury, UO_pressure_unit},
    {UO_milligram_per_liter, UO_mass_density_unit},
    {UO_microgram_per_milliliter, UO_mass_density_unit},
    {UO_nanogram_per_milliliter, UO_mass_density_unit},
    {UO_amount_per_container, UO_concentration_unit},
    {UO_ug_disk, UO_amount_per_container},
    {UO_nmole_disk, UO_amount_per_container},
    {UO_milliunits_per_milliliter, UO_unit_per_volume_unit},
    {UO_rate_unit, UO_unit},
    {UO_count_per_nanomolar_second, UO_rate_unit},
    {UO_count_per_molar_second, UO_rate_unit},
    {UO_kilogram_per_hectare, UO_area_density_unit},
    {UO_count_per_nanomolar, UO_rate_unit},
    {UO_count_per_molar, UO_rate_unit},
...
CVIDPair relationsPartOf_[] =
{
    ...
    {MS_sequential_m_z_separation_method, MS_purgatory},
    ...
    {MS_search_result_details_OBSOLETE, MS_purgatory},
    {MS_search_input_details, MS_spectrum_interpretation},
    {MS_add_others_OBSOLETE, MS_purgatory},
    ...
    {MS_quantification_data_processing, MS_spectrum_interpretation},
    {MS_transition_validation_attribute, MS_transition},
    {MS_source_interface, MS_source},
    {MS_source_interface_model, MS_source_interface},
    {MS_source_sprayer, MS_source},
    {MS_source_sprayer_type, MS_source_sprayer},
    {MS_source_sprayer_manufacturer, MS_source_sprayer},
    {MS_source_sprayer_model, MS_source_sprayer},
    {MS_sample_plate, MS_source},
    {MS_sample_plate_type, MS_sample_plate},
    {MS_electrospray_supply_type, MS_source},
    {MS_source_interface_manufacturer, MS_source_interface},
    {MS_acquisition_parameter, MS_spectrum_generation_information},
    {MS_peptide_spectrum_match_scoring_algorithm, MS_spectrum_generation_information},
    {MS_SRM_transition_type, MS_transition},
    {MS_inlet_attribute, MS_source},
}; // relationsPartOf_
...
OtherRelationPair relationsOther_[] =
{
    ...
    {MS_tube_lens_voltage, "has_units", UO_volt},
    ...
    {MS_product_ion_m_z, "has_units", MS_m_z},
    {MS_product_ion_intensity, "has_units", MS_number_of_counts},
    {MS_product_ion_intensity, "has_units", MS_percent_of_base_peak},
    {MS_product_ion_intensity, "has_units", MS_counts_per_second},
    {MS_product_ion_intensity, "has_units", MS_percent_of_base_peak_times_100},
    {MS_product_ion_m_z_error, "has_units", MS_m_z},
    {MS_product_ion_m_z_error, "has_units", UO_parts_per_notation_unit},
    {MS_local_FDR, "has_units", UO_parts_per_notation_unit},
    ...
    {MS_search_tolerance_plus_value, "has_units", UO_parts_per_notation_unit},
    {MS_search_tolerance_plus_value, "has_units", UO_percent},
    {MS_search_tolerance_plus_value, "has_units", UO_dalton},
    {MS_search_tolerance_minus_value, "has_units", UO_parts_per_notation_unit},
    ...
    {MS_q_value_for_peptides, "has_units", UO_parts_per_notation_unit},
    {MS_q_value_for_peptides, "has_units", UO_percent},
    {MS_q_value_for_proteins, "has_units", UO_parts_per_notation_unit},
    {MS_q_value_for_proteins, "has_units", UO_percent},
    {MS_offset_voltage, "has_units", UO_volt},
    {MS_retention_time_window_width, "has_units", UO_second},
    {MS_retention_time_window_width, "has_units", UO_minute},
    {MS_S_lens_voltage, "has_units", UO_volt},
    {MS_leukocyte_elastase, "has_regexp", MS______ALIV_____P_},
    {MS_proline_endopeptidase, "has_regexp", MS______HKR_P____P_},
    {MS_glutamyl_endopeptidase, "has_regexp", MS_______E_E_},
    {MS_2_iodobenzoate, "has_regexp", MS_____W_},
    {MS_Digital_Object_Identifier__DOI_, "has_regexp", MS______KR_____P_},
    {MS_Collision_cell_exit_potential, "has_units", UO_volt},
    {MS_product_ion_drift_time, "has_units", UO_millisecond},
    {MS_delta_m_z, "has_units", UO_parts_per_notation_unit},
    {MS_delta_m_z, "has_units", UO_percent},
    {MS_delta_m_z, "has_units", UO_dalton},
    {MS_delta_M, "has_units", UO_parts_per_notation_unit},
    {MS_delta_M, "has_units", UO_percent},
    {MS_delta_M, "has_units", UO_dalton},
    {MS_Mascot_PTM_site_assignment_confidence, "has_units", UO_percent},
    {MS_collision_energy_ramp_start, "has_units", UO_electronvolt},
    {MS_collision_energy_ramp_end, "has_units", UO_electronvolt},
    {MS_inlet_temperature, "has_units", UO_kelvin},
    {MS_inlet_temperature, "has_units", UO_degree_celsius},
    {MS_source_temperature, "has_units", UO_kelvin},
    {MS_source_temperature, "has_units", UO_degree_celsius},
    {MS_modulation_time, "has_units", UO_second},
    {MS_modulation_time, "has_units", UO_minute},
}; // relationsOther_
...
CVIDStringPair relationsExactSynonym_[] =
{
    ...
    {MS_collision_induced_dissociation, "CAD"},
    {MS_collision_induced_dissociation, "collision activated dissociation"},
    ...
    {MS_high_energy_collision_induced_dissociation, "HCD"},
    {MS_photodissociation, "multiphoton dissociation"},
    {MS_photodissociation, "MPD"},
    ...
    {MS_travelling_wave_ion_mobility_mass_spectrometer, "TWIMS"},
    {MS_glutamyl_endopeptidase, "staphylococcal protease"},
    {MS_glutamyl_endopeptidase, "Glu-C"},
    {MS_Collision_cell_exit_potential, "CXP"},
    {MS_delta_m_z, "m/z difference"},
    {MS_delta_M, "mass difference"},
    {MS_sophisticated_numerical_annotation_procedure, "SNAP"},
    {MS_SRM_transition_type, "MRM transition type"},
    {MS_target_SRM_transition, "target MRM transition"},
    {MS_decoy_SRM_transition, "decoy MRM transition"},
    {MS_desorption_electrospray_ionization, "DESI"},
    {MS_unlabeled_sample, "light labeled sample"},
    {UO_time_unit, "time derived unit"},
    {UO_temperature_unit, "temperature derived unit"},
    {UO_meter, "m"},
    {UO_kilogram, "kg"},
    {UO_second, "s"},
    {UO_ampere, "A"},
    ...
    {UO_milligram_per_liter, "mg/L"},
    {UO_microgram_per_milliliter, "ug/ml"},
    {UO_nanogram_per_milliliter, "ng/ml"},
    {UO_milliunits_per_milliliter, "mU/ml"},
    {UO_count_per_nanomolar_second, "nM^-1 s^-1"},
    {UO_count_per_molar_second, "M^-1 s^-1"},
    {UO_count_per_nanomolar, "nM^-1"},
    {UO_count_per_nanomolar, "1/nM"},
    {UO_count_per_molar, "M^-1"},
    {UO_count_per_molar, "1/M"},
...
PropertyValuePair propertyValue_[] =
{
    {CVID_Unknown, "Unknown", "Unknown"},
}; // propertyValue_


const size_t propertyValueSize_ = sizeof(propertyValue_)/sizeof(PropertyValuePair);
...
class CVTermData : public boost::singleton<CVTermData>
{
    ...
    CVTermData(boost::restricted)
    {
        ...
        cvMap_["MS"].id = "MS";
        cvMap_["MS"].version = "3.30.0";

        cvMap_["UO"].id = "UO";
        cvMap_["UO"].version = "12:10:2011";
...
#include "cv.inl" // code and data that doesn't change with CV releases
