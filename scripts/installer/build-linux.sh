#!/bin/bash
# Build the pwiz-sharp Linux packages. Linux counterpart of scripts/installer/build.ps1.
#
...
PROJ="$PWIZ_SHARP/pwiz_tools/Commandline/MsConvert/src/MsConvert.csproj"
RID=linux-x64
