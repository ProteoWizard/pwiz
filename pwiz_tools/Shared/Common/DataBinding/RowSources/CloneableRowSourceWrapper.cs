...
{
    public class CloneableRowSourceWrapper<TKey, TItem> : AbstractRowSourceWrapper
    {
        ...
        {
            var sublistColumns = queryResults.Pivoter.SublistColumns.ToDictionary(cd => cd.IdPath);
            return queryResults
        ...
        private IEnumerable<RowItem> MakeLive(IDictionary<IdentifierPath, ColumnDescriptor> sublistColumns,
        ...
        private RowItem MakeLive(IDictionary<IdentifierPath, ColumnDescriptor> sublistColumns, RowItem rowItem)
        {
