...
namespace pwiz.Common.DataBinding.Controls
{
    public partial class NameLayoutForm : CommonFormEx
    {
        ...
        public void OkDialog()
        {
            ...
            {
                ViewContext.ShowMessageBox(this, Resources.NameLayoutForm_OkDialog_Name_cannot_be_empty, MessageBoxButtons.OK, null);
                return;
            }
            if (_existingNames.Contains(LayoutName))
            {
                if (DialogResult.Yes !=ViewContext.ShowMessageBox(this, string.Format(Resources.NameLayoutForm_OkDialog_You_already_have_a_layout_named___0____Do_you_want_to_replace_it_, LayoutName), MessageBoxButtons.YesNo, null))
                {
                    return;
                }
            }
