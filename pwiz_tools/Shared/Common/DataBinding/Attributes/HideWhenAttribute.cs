...
{
    /// <summary>
    /// Attribute which causes columns to be hidden under certain conditions.
    /// This attribute is typically used to hide redundant columns that could
    /// be drilled into to infinite levels.
    /// </summary>
