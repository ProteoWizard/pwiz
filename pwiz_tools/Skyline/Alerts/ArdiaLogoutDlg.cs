    ...
    public partial class ArdiaLogoutDlg : FormEx
    {
        ...
        private async void InitializeWebView()
        {
            ...
            if (logoutUrl != null && webView != null && webView.CoreWebView2 != null)
            {
                ...
                var url =
                    $"https://api.{_baseUrl}{logoutUrl}&applicationcode={applicationCode}&returnUrl=https://{_baseUrl}/";
                ...
                MessageDlg.Show(this, "User logged out successfully.");
            }
        }
        ...
        private async Task GetCookies()
        {
            ...
            var cookies = await webView.CoreWebView2.CookieManager.GetCookiesAsync($"https://{_baseUrl}");
