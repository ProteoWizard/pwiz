...
{
    public class PeakBoundaryAlerts
    {
        public PeakBoundaryAlerts(PeakBoundaryImporter peakBoundaryImporter)
        {
            Importer = peakBoundaryImporter;
        }

        public PeakBoundaryImporter Importer { get; }
        /// <summary>
