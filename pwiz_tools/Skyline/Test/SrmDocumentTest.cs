...
namespace pwiz.SkylineTest
{
    ...
    public class SrmDocumentTest : AbstractUnitTest
    {
        ...
        private static void ValidateDocMolecules(string docText, bool imTypeIsDriftTime=true)
        {
            ...
            Assert.AreEqual(4.704984, doc.MoleculeTransitions.ElementAt(0).GetExplicitCollisionEnergy(nodeGroup));
            ...
            Assert.AreEqual(4.9, doc.MoleculeTransitions.ElementAt(0).GetExplicitDeclusteringPotential(nodeGroup));
            ...
            Assert.AreEqual(98, doc.MoleculeTransitions.ElementAt(0).GetExplicitSLens(nodeGroup));
            Assert.AreEqual(99, doc.MoleculeTransitions.ElementAt(0).GetExplicitConeVoltage(nodeGroup));
            Assert.AreEqual(expectedIonMobility, doc.MoleculeTransitionGroups.ElementAt(0).ExplicitValues.IonMobility);
            Assert.AreEqual(-0.12, doc.MoleculeTransitions.ElementAt(0).GetExplicitIonMobilityHighEnergyOffset(nodeGroup).Value, 1E-12);
