...
namespace pwiz.SkylineTest
{
    ...
    public class AnnotationUnitTest : AbstractUnitTest
    {
        ...
        public void AnnotationMergeTest()
        {
            ...
            var annotations3 = Annotations.FromValues(note2, null, -1);
            ...
            // Check color merging
            var annotationsColor = Annotations.FromValues("color", null, 0);
            ...
            var annotationsComplex1 = Annotations.FromValues(note1, new[] {new KeyValuePair<string, string>(annotationName1, "Test")}, -1);
            ...
            var annotationsComplex4 = Annotations.FromValues(null,
                new[]
                {
                    new KeyValuePair<string, string>("NewName", "Value"),
