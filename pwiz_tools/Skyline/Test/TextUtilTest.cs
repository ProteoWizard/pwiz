    ...
    public class TextUtilTest : AbstractUnitTest
    {
        ...
        {   
            ...
            var orderSampleStressTest = new List<string>()
            {
                ...
                "-BAsh","bBs3C","BCMcu","be6BM","bEhRG","bgGUv","bhbJs","bHv3e","bi4T8","BkDgK","BLU9m","bMce4",
                "Bnsal","bNsP7","BNV2G","Bogdb","BRrbj","Bs9x_","bsXG1","BUCTk","BUhsx","bvM8c","Bvmf1","bwFBH",
                "-By5e","BYFPD","byt8M","bZcOx","bzUgj","bZYSN","c7yUJ","c8qdT","C59ka","CB3hc","cB4he","CdaAF",
                ...
                "jKPV1","JlIqH","JmGDD","JmnSV","jnLi3","joLig","JRbIh","JTvux","jU_7h","-juCa","juvFl","jUWvE",
                ...
                "N12Sj","naLxD","NaxoJ","NbF-u","nBiC1","nBoHo","ncV0O","NdZmd","ne-LG","-NhkU","nhMEq","NhsZW",
                ...
                "-qsu8","qSYbA","QtlMD","qVHOo","qWMe_","QwrRK","QWVV7","qWWeF","QWwUL","QyA53","qZwkK","r2U32",
                ...
                "-uG-g","UIQF2","UJt7P","UjY-6","uk2zH","UN_mf","UNGYS","uNZ49","UoTD9","uP0_z","UpBUn","UPLhZ",
                ...
                "XfWhr","XfY9w","xgThP","-XI_N","XiSQ3","XJ0Ij","xJl17","XjWWj","XlGMw","xlt5k","XMgjD","XPCHC",
                ...
                "yIaqR","YJ_Bw","ykUfT","Ylp6y","ymA2t","yPNFs","-yqQU","YS_68","YsfqU","YtEmi","ytYCY","YtZZ8",
