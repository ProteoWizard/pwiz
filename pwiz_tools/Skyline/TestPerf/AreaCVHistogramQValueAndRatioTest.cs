...
namespace TestPerf
{
    ...
    public class AreaCVHistogramQValueAndRatioTest : AbstractFunctionalTestEx
    {
        private static readonly AreaCVGraphDataStatistics[] STATS =
        {
            ...
            new AreaCVGraphDataStatistics(2269, 2269, 3.85, 8.5, 12291, 1.56, 0, 42, 0.095164067507682137, 0.13255471483199055, 0.80701326173622978),
            new AreaCVGraphDataStatistics(5847, 5847, 3.1, 7.45, 18608, 1.71, 0, 17, 0.50598026540976015, 0.53897463456577754, 0.13392089423903697),
            new AreaCVGraphDataStatistics(2494, 2494, 3.6500000000000004, 8.5, 13187, 1.56, 0, 42, 0.10081787157698326, 0.14358231591719073, 0.78357473269128686),
            new AreaCVGraphDataStatistics(2129, 2129, 3.9000000000000004, 8.5, 11312, 1.56, 0, 40, 0.095865673556778247, 0.13204738330975938, 0.81108557284299854),
            ...
            new AreaCVGraphDataStatistics(201, 201, 3.7, 7, 247, 3.63, 0.28, 4, 2.2389780149590934, 2.239959514170041, 0),
            new AreaCVGraphDataStatistics(203, 203, 3.7, 7, 246, 2.1, 0.06, 4, 0.15889171184485773, 0.2700406504065041, 0.64634146341463417),
            new AreaCVGraphDataStatistics(233, 233, 3.7, 7, 250, 3.63, 0.06, 3, 1.24900414453809, 1.2632800000000002, 0.32),
        };
