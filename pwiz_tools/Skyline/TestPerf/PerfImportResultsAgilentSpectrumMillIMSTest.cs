...
{
    /// <summary>
    /// Verify consistent import of Agilent IMS data in convert with SpectrumMill.
    /// </summary>
    [TestClass]
    public class ImportAgilentSpectrumMillIMSTest : AbstractFunctionalTest
    {
        ...
        protected override void DoTest()
        {
            ...
            var numPeaks = new[] { 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 9, 10, 10, 6, 6, 10, 10, 10, 6, 9, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 4, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10};
            int npIndex = 0;
            var errmsg = "";
            ...
            Assert.AreEqual(1643104, maxHeight, 1);
        }  
    }
}
