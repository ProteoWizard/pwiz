    ...
    public class PerfImportBrukerPrmPasefTest : AbstractFunctionalTestEx
    {
        ...
        private void TestReports(SrmDocument doc1, string msg = null)
        {
            ...
            var rts = new double?[] {
                ...
                18.34, 11.16, 10.46, 10.98, 28, 24.01, 11.15, 18.97, 23.33, 26.56, 11.94, 19, 24.2, 23.42, 26.1, 27.87, 27.76, 20.8, 26.15,
                ...
                22.72, 8.45, 11.17, 18.41, 18.85, 22.18, 16.56, 10.02, 10.13, 25.91
            };
