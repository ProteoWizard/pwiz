...
namespace TestPerf // Note: tests in the "TestPerf" namespace only run when the global RunPerfTests flag is set
{
    ...
    public class PerfImportBrukerPrmPasefTest : AbstractFunctionalTestEx
    {
        ...
        protected override void DoTest()
        {
            ...
            AssertEx.AreEqual(501023.34375, maxHeight, 1); 
        ...
        private void TestReports(string msg = null)
        {
            ...
            CheckDocumentResultsGridFieldByName(documentGrid, "PrecursorResult.CollisionalCrossSection", row, 395.46, msg);
            EnableDocumentGridColumns(documentGrid,
                Resources.ReportSpecList_GetDefaults_Peptide_RT_Results,
                210);
            var rts = new double?[] {
                12.43, 21.48, 16.93, 22.93, 13.63, 18.97, 28.97, 14.88, 14.22, 27.25, 22.28, 14.97, 14.26, 25.7, 15.06, 14.15, 11.93,
                26.37, 12.88, 15.88, 18.35, 11.16, 10.47, 10.98, 27.69, 24.01, 11.15, 18.97, 23.33, 26.56, 11.94, 19, 24.2, 20.75, 26.1,
                27.87, 27.76, 20.77, 26.13, 21.16, 25.99, 14.29, 26.04, 15.04, 24.07, 28.15, 20.1, 26.03, 15.07, 19.78, 27.2, 21.26, 25.39,
                25.04, 11.71, 21.1, 20.51, 14.71, 25.24, 24.9, 28.57, 20.98, 17.19, 15.26, 18.08, 15.86, 26.11, 10.27, 13.11, 9.46, 10.78,
                14.07, 25.16, 26.36, 17.21, 24.79, 13.89, 20.99, 19.7, 22.5, 13.96, 19.35, 16.4, 19.05, 18.45, 13.96, 6.59, 26.12, 17.76,
                28.31, 24.14, 29.25, 27.56, 23.72, 12.08, 8.92, 18.39, 20.23, 26.42, 28.45, 22.16, 14.88, 24.73, 28.22, 17.16, 8.94, 13.86,
                22.91, 17.14, 19.92, 24.24, 27.82, 24.67, 10.41, 12.27, 21.21, 18.69, 12.68, 21.09, 22.28, 21.43, 14.49, 17.31, 21.91, 22.43,
                19.53, 25.24, 25.31, 11.61, 25.79, 10.07, 24.3, 23.28, 15.83, 14.87, 28.54, 14.85, 13.51, 28.5, 22.49, 19.35, 24.81, 24.57,
                24.63, 24.36, 15.46, 22.7, 20.42, 22.56, 21.91, 15.97, 21.81, 13.62, 19.52, 15.55, 23.71, 30.35, 19.52, 13.57, 29.08, 15.56,
                21.73, 16.05, 13.95, 25.39, 14.31, 25.3, 15.72, 10.48, 9.88, 21.31, 9.92, 27.89, 29.85, 22.12, 25.34, 21.53, 15.25, 21.17,
                22.81, 20.44, 18.23, 11.49, 25.59, 20.13, 16.32, 13.19, 9.63, 12.11, 21.84, 10.83, 12.49, 16.99, 18.83, 11.71, 12.84, 17.31,
                11.13, 12.88, 24.35, 16.83, 15.26, 22.72, 8.45, 11.17, 18.41, 18.85, 22.18, 16.56, 10.02
            };
