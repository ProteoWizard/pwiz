    ...
    public class PerfThermoFAIMSTest : AbstractFunctionalTestEx
    {
        ...
        protected override void DoTest()
        {
            ...
            RunUI(() => SkylineWindow.ModifyDocument("Set Orbitrap full-scan settings", doc => doc.ChangeSettings(
                ...
                .ChangeTransitionSettings(ts => ts.ChangeIonMobility(ts.IonMobility.ChangeSpectralLibraryIonMobilityWindowWidthCalculator(
                        new IonMobilityWindowWidthCalculator(IonMobilityWindowWidthCalculator.IonMobilityPeakWidthType.resolving_power, 20, 0, 0))
