  ...
  public static partial class ModelReflection {
    ...
    static ModelReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cgttb2RlbC5wcm90bxISdGVuc29yZmxvdy5zZXJ2aW5nIhsKCkludDY0VmFs",
            "dWUSDQoFdmFsdWUYASABKAMiYgoJTW9kZWxTcGVjEgwKBG5hbWUYASABKAkS",
            "LwoHdmVyc2lvbhgCIAEoCzIeLnRlbnNvcmZsb3cuc2VydmluZy5JbnQ2NFZh",
            "bHVlEhYKDnNpZ25hdHVyZV9uYW1lGAMgASgJQgP4AQFiBnByb3RvMw=="));
  ...
  public sealed partial class ModelSpec : pb::IMessage<ModelSpec> {
    ...
    public void MergeFrom(ModelSpec other) {
      ...
      if (other.version_ != null) {
        if (version_ == null) {
          version_ = new global::Tensorflow.Serving.Int64Value();
        }
