...
namespace pwiz.Skyline.Model.Serialization
{
    ...
    public struct DocumentFormat : IComparable<DocumentFormat>
    {
        ...
        public static readonly DocumentFormat VERSION_22_14 = new DocumentFormat(22.14); // multiple conformers added
        public static readonly DocumentFormat MULTIPLE_CONFORMERS = VERSION_22_14; // First version with support for multiple ion mobilities for single precursor
        public static readonly DocumentFormat CURRENT = VERSION_22_14;
