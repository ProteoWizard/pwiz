...
namespace pwiz.Skyline.Model.Serialization
{
    ...
    public struct DocumentFormat : IComparable<DocumentFormat>
    {
        ...
        public static readonly DocumentFormat VERSION_23_11 = new DocumentFormat(23.11); // keep_unmapped_peptides
        public static readonly DocumentFormat KEEP_UNMAPPED_PEPTIDES = VERSION_23_11;
