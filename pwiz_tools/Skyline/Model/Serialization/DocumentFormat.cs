...
namespace pwiz.Skyline.Model.Serialization
{
    ...
    public struct DocumentFormat : IComparable<DocumentFormat>
    {
        ...
        public static readonly DocumentFormat VERSION_22_24 = new DocumentFormat(22.24); // Group Comparison MS level, spectrum class filters
        public static readonly DocumentFormat CURRENT = VERSION_22_24;
