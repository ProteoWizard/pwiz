...
namespace pwiz.Skyline.Model.Serialization
{
    ...
    public struct DocumentFormat : IComparable<DocumentFormat>
    {
        ...
        public static readonly DocumentFormat VERSION_22_11 = new DocumentFormat(21.22); // zh and zhh ion types added to the schema.
        public static readonly DocumentFormat CURRENT = VERSION_22_11;
