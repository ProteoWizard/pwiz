...
//            bool userSet = reader.GetBoolAttribute(ATTR.user_set);
        ...
        public void ReadXml(XmlReader reader, DocumentFormat formatVersion, out double? declaredMz, ExplicitTransitionValues pre422ExplicitTransitionValues)
            ...
            public void ReadXmlElements(XmlReader reader, out double? declaredProductMz)
            {
                ...
                LinkedFragmentIons = new List<FragmentIonType?>();
                if (reader.IsEmptyElement)
                {
                    reader.Read();
                }
            ...
            private KeyValuePair<ModificationSite, ComplexFragmentIonName> ReadLegacyLinkedFragmentIon(XmlReader reader)
            {
            ...
            private FragmentIonType? ReadLinkedFragmentIon(XmlReader reader)
            {
                ...
                reader.Read();
                return ionType == IonType.custom ? FragmentIonType.Empty : new FragmentIonType(ionType, ordinal);
            }
