...
namespace pwiz.Skyline.Model.Databinding.Entities
{
    ...
    public class PrecursorResult : Result
    {
        ...
        [Format(Formats.RETENTION_TIME, NullValue = TextUtil.EXCEL_NA)]
        public double? IonMobilityWindow { get { return ChromInfo.IonMobilityInfo.IonMobilityWindow.Width; } }
        [Format(Formats.RETENTION_TIME, NullValue = TextUtil.EXCEL_NA)]
        public double? IonMobilityWindowOffset { get { return ChromInfo.IonMobilityInfo.IonMobilityWindow.Offset; } }
