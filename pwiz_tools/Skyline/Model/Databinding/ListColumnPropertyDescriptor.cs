    ...
    public class ListColumnPropertyDescriptor : PropertyDescriptor
    {
        ...
        public override void SetValue(object component, object value)
        {
            ...
            SkylineDataSchema.ModifyDocument(EditDescription.SetAnnotation(AnnotationDef, value), doc =>
            {
                ...
                if (listInfo == null)
                {
                    throw new InvalidOperationException("List has been deleted");
                }
                ...
                if (rowIndex < 0)
                {
                    throw new ArgumentException("List item has been deleted.");
                }
        ...
        private DataSettings ChangeListData(DataSettings dataSettings, ListData listData)
        {
            ...
            throw new ArgumentException(string.Format("No such list {0}", listData.ListDef.Name));
        }
