...
namespace pwiz.Skyline.Model.Results.Scoring
{
    ...
    public class ScoredGroupPeaksSet
    {
        ...
        /// <param name="replaceInvalidFeatureScores">Whether feature scores which are NaN or infinity should be replaced with zero</param>
        /// <returns>Mean peak score.</returns>
        public void ScorePeaks(IList<double> weights, bool replaceInvalidFeatureScores)
        {
            ParallelEx.For(0, _scoredGroupPeaksList.Count, i =>
            {
                ...
                {
                    scoredPeaks[j] = scoredPeaks[j].CalcScore(weights, replaceInvalidFeatureScores);
                }
            });
