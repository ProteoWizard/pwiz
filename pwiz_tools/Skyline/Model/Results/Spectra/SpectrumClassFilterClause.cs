...
namespace pwiz.Skyline.Model.Results.Spectra
{
    ...
    /// </summary>
    [XmlRoot(XML_ROOT)]
    public class SpectrumClassFilterClause : Immutable, IXmlSerializable, IComparable, IComparable<SpectrumClassFilterClause>, IEquatable<SpectrumClassFilterClause>
    {
        public const string XML_ROOT = "spectrum_filter";
        public SpectrumClassFilterClause(IEnumerable<FilterSpec> filterSpecs)
        {
        ...
        public bool Equals(SpectrumClassFilterClause other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((SpectrumClassFilterClause)obj);
        }
        ...
        private SpectrumClassFilterClause()
        {
        }
        ...
        public static SpectrumClassFilterClause Deserialize(XmlReader xmlReader)
        {
            return xmlReader.Deserialize(new SpectrumClassFilterClause());
        }

        public int CompareTo(SpectrumClassFilterClause other)
        {
            if (other == null)
            {
                return 1;
        ...
        {
            return CompareTo((SpectrumClassFilterClause) obj);
        }
