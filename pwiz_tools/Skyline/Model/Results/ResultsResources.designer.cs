...
namespace pwiz.Skyline.Model.Results {
    ...
    public class ResultsResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to CCS={0}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to  High Energy Offset={0:F04}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to IM={0:F04}{1}{2}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to No isolation window found in {0} for precursor {1} (m/z={2} {3}).
        /// </summary>
