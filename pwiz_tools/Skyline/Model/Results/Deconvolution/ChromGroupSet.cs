...
{
    public class ChromGroupSet : IEnumerable<ChromatogramGroupInfo>
    {
        ...
        public ChromatogramGroupInfo this[int index]
        {
            get
            {
                return Entries[index].ChromatogramGroupInfo;
            }
        }

        IEnumerator IEnumerable.GetEnumerator()
        {
            return Entries.Select(e => e.ChromatogramGroupInfo).GetEnumerator();
        }

        IEnumerator<ChromatogramGroupInfo> IEnumerable<ChromatogramGroupInfo>.GetEnumerator()
        {
            return Entries.Select(e => e.ChromatogramGroupInfo).GetEnumerator();
        }
