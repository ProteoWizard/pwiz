...
namespace pwiz.Skyline.Model
{
    public class SkylineVersion : LabeledValues<string>, IComparable<SkylineVersion>
    {
        ...
        public static readonly SkylineVersion V20_12 = new SkylineVersion(() => Resources.SkylineVersion_V20_1_Skyline_20_1,
            @"Skyline 20.12",
            CacheFormatVersion.Fifteen, DocumentFormat.VERSION_20_12);
        ...
        {
            List<SkylineVersion> versions = new List<SkylineVersion> { V20_12, V20_1, V19_1, V4_2, V4_1, V3_7, V3_6 };
