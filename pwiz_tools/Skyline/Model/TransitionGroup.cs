...
namespace pwiz.Skyline.Model
{
    public class TransitionGroup : Identity
    {
                                                        ...
                                                        IFragmentMassCalc calc)
        {
            ...
            var nodeTranMatching = new TransitionDocNode(tranNew, losses, massH, new TransitionDocNode.TransitionQuantInfo(isotopeDistInfo, libInfo, nodeTran.IsQuantitative(settings)), nodeTran.BareExplicitValues);
