...
namespace pwiz.Skyline.Model.DdaSearch {
    ...
    public class DdaSearchResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Hardklor searches for peptide-like features using an averagine model. Features found by Hardklor are represented in Skyline as small molecules with the chemical formula that Hardklor used to generate the isotope envelope used in locating the feature. It&apos;s important to understand that this is not the actual formula of the feature, just a suitable approximation for isotope distribution calculation..
        /// </summary>
