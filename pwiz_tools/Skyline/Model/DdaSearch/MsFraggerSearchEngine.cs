...
namespace pwiz.Skyline.Model.DdaSearch
{
    public class MsFraggerSearchEngine : AbstractDdaSearchEngine, IProgressMonitor
    {
        ...
        public MsFraggerSearchEngine(double percolatorQvalueCutoff, bool dataIsDIA)
        {
            ...
            AddAdditionalSetting(MSFRAGGER_SETTINGS, new Setting("remove_precursor_peak", DataIsDIA ? 1 : 0, 0, 1)); //   Remove precursor peaks from tandem mass spectra. 0 = not remove; 1 = remove the peak with precursor charge; 2 = remove the peaks with all charge states (only for DDA mode).
