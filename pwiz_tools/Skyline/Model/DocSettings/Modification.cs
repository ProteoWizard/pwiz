...
// ReSharper restore InconsistentNaming
    ...
    {
        public TransitionLoss(StaticMod precursorMod, FragmentLoss loss, MassType massType) : this()
        {
    ...
    {
        public ExplicitLoss(int indexAA, TransitionLoss transitionLoss) : this()
        {
            IndexAA = indexAA;
