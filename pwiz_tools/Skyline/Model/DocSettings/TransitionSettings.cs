...
// ReSharper restore InconsistentNaming
    ...
    public class TransitionFilter : Immutable, IXmlSerializable
    {
        ...
        {
            return list.ToArray().ToString(@", "); // ? Internationalization of comma?
        }
            ...
            get
            {
                if (_fragmentStartFinders == null)
                {
                    _fragmentStartFinders = new MappedList<string, StartFragmentFinder>
                    {
                        ...
                        new OrdinalFragmentFinder(@"ion 1", () => Resources.TransitionFilter_FragmentStartFinders_ion_1, 1),
                        new OrdinalFragmentFinder(@"ion 2", () => Resources.TransitionFilter_FragmentStartFinders_ion_2, 2),
                        new OrdinalFragmentFinder(@"ion 3", () => Resources.TransitionFilter_FragmentStartFinders_ion_3, 3),
                        new OrdinalFragmentFinder(@"ion 4", () => Resources.TransitionFilter_FragmentStartFinders_ion_4, 4),
                        new MzFragmentFinder(DEFAULT_START_FINDER, () => Resources.TransitionFilter_FragmentStartFinders_m_z_precursor, 0),
                        new MzFragmentFinder(@"(m/z > precursor) - 1", () => Resources.TransitionFilter_FragmentStartFinders_m_z_precursor_minus_1, -1),
                        new MzFragmentFinder(@"(m/z > precursor) - 2", () => Resources.TransitionFilter_FragmentStartFinders_m_z_precursor_minus_2, -2),
                        new MzFragmentFinder(@"(m/z > precursor) + 1", () => Resources.TransitionFilter_FragmentStartFinders_m_z_precursor_plus_1, 1),
                        new MzFragmentFinder(@"(m/z > precursor) + 2", () => Resources.TransitionFilter_FragmentStartFinders_m_z_precursor_plus_2, 2)
                    };
...
// ReSharper disable InconsistentNaming
    ...
    public enum FullScanAcquisitionMethod { None, Targeted, DIA } // : Not used for combo boxes.
