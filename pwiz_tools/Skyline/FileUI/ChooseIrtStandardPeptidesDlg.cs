...
namespace pwiz.Skyline.FileUI
{
    public partial class ChooseIrtStandardPeptidesDlg : FormEx
    {
        ...
        private void ImportTextFile()
        {
            ...
            {
                Title = FileUIResources.ChooseIrtStandardPeptides_ImportTextFile_Import_Transition_List__iRT_standards_,
                InitialDirectory = Path.GetDirectoryName(_documentFilePath),
                DefaultExt = TextUtil.EXT_CSV,
                Filter = TextUtil.FileDialogFiltersAll(TextUtil.FileDialogFilter(FileUIResources.ChooseIrtStandardPeptides_ImportTextFile_Transition_List, TextUtil.EXT_CSV, TextUtil.EXT_TSV))
            })
            {
                if (dlg.ShowDialog(this) == DialogResult.OK)
                {
