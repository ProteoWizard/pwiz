namespace pwiz.Skyline.FileUI.PeptideSearch
{
    partial class BuildPeptideSearchLibraryControl
    {
      ...
      this.radioDDASearch = new System.Windows.Forms.RadioButton();
      ...
      // panel1
      // 
      this.panel1.Controls.Add(this.radioDDASearch);
      ...
      // radioDDASearch
      // 
      resources.ApplyResources(this.radioDDASearch, "radioDDASearch");
      this.radioDDASearch.Name = "radioDDASearch";
      this.radioDDASearch.TabStop = true;
      this.radioDDASearch.UseVisualStyleBackColor = true;
      this.radioDDASearch.CheckedChanged += new System.EventHandler(this.radioDDASearch_CheckedChanged);
      // 
      ...
      this.ResumeLayout(false);
        ...
        private System.Windows.Forms.RadioButton radioDDASearch;
    }
}
