...
namespace pwiz.Skyline.FileUI.PeptideSearch
{
    public partial class ImportFastaControl : UserControl
    {
        ...
        private bool browseForFasta(out string fastaFilepath)
        {
            ...
            {
                Title = PeptideSearchResources.ImportFastaControl_browseFastaBtn_Click_Open_FASTA,
            ...
            else // The user specified some FASTA content
            {
                ...
                try
                {
                    if (!_fastaFile)
                    {
                        ...
                        using (var longWaitDlg = new LongWaitDlg(DocumentContainer) { Text = PeptideSearchResources.ImportFastaControl_ImportFasta_Insert_FASTA })
                        {
