    ...
    public partial class ImportTransitionListColumnSelectDlg : ModeUIInvariantFormEx, ITipDisplayer
    {
        ...
        public static List<HeaderDocType> GetKnownHeaderTypes(bool isAssayLibraryImport)
        {
            ...
            return new List<HeaderDocType>
            {
                ...
                CreateKnownHeaderDocType(Resources.ImportTransitionListColumnSelectDlg_PopulateComboBoxes_iRT,SrmDocument.DOCUMENT_TYPE.mixed),
                ...
                CreateKnownHeaderDocType(Resources.ImportTransitionListColumnSelectDlg_PopulateComboBoxes_Library_Intensity,SrmDocument.DOCUMENT_TYPE.mixed),
                ...
                try
                {
                    ...
                    longWaitDlg.PerformWork(this, 1000, progressMonitor =>
                    {
                        ...
                        insertionParams.Document = _docCurrent.ImportMassList(_inputs, Importer, progressMonitor,
                            ...
                            out insertionParams.LibrarySpectra, out var testErrorList, out insertionParams.PeptideGroups, true, insertionParams.ColSelections, GetRadioType(), hasHeaders,
