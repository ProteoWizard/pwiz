...
namespace pwiz.Skyline.Util
{
    ...
    public abstract class AbstractPanoramaPublishClient : IPanoramaPublishClient
    {
        ...
        // protected AbstractPanoramaPublishClient(Uri serverUri, string username, string password) : base(serverUri, username, password)
        // {
        // }
        ...
        //     using (_requestHelper = GetWebClientFactory().Create(server.URI, server.Username, server.Password))
        //     {
        ...
        //             DeleteTempZipFile(tmpUploadUri, server.AuthHeader, _requestHelper);
        //             return null;
        //         }
        //
        //         // Make sure the temporary file was uploaded to the server
        //         ConfirmFileOnServer(tmpUploadUri, server.AuthHeader, _requestHelper);
        //
        ...
        //
        //         RenameTempZipFile(tmpUploadUri, uploadUri, server.AuthHeader, _requestHelper);
        //
        ...
        //             return null;
        //
        //         JToken jStatusResponse = _requestHelper.Get(statusUri);
        ...
        //     };
        //
        //     JToken importResponse = _requestHelper.Post(importUrl, dataImportInformation, "There was an error adding the document import job on the server.");
        //     
        //
        ...
        // {
        //     _requestHelper.AddUploadFileCompletedEventHandler(webClient_UploadFileCompleted);
        //     _requestHelper.AddUploadProgressChangedEventHandler(webClient_UploadProgressChanged);
        //
        ...
        //         _requestHelper.AddHeader(@"Temporary", @"T");
        //         _requestHelper.RequestJsonResponse();
        //         _requestHelper.AsyncUploadFile(tmpUploadUri, @"PUT",
        ...
        //     _requestHelper.RemoveHeader(@"Temporary");
        //
        //     return tmpUploadUri;
        // }
        //
        ...
        //
        //     var jsonResponse = _requestHelper.Get(getPipelineContainerUri);
        ...
        //         _requestHelper.CancelAsyncUpload();
        // }
        //
        ...
        //         _uploadError = serverResponse != null ? PanoramaUtil.GetIfErrorInResponse(serverResponse) : null;
        //     }
        // }
    }
    ...
    {
        private WebPanoramaClientForPublish _publishClient;
        public WebPanoramaPublishClient(Uri serverUri, string username, string password)
        {
            _publishClient = new WebPanoramaClientForPublish(serverUri, username, password);
        }
        ...
        public override IPanoramaClient PanoramaClient => _publishClient;
    ...
    public class WebPanoramaClientForPublish : WebPanoramaClient
    {
        public WebPanoramaClientForPublish(Uri serverUri, string username, string password) : base(serverUri, username, password)
        {
        }
        public override IRequestHelperFactory GetRequestHelperFactory()
        {
            return new PublishWebRequestHelperFactory();
        }
    ...
    // public class PublishDocRequestClientWrapper : RequestClientWrapper<WebPanoramaPublishHelper>, IPublishRequestClient
    // {
    //     private NonStreamBufferingWebClient _client;
    //
    //     public PublishDocRequestClientWrapper(Uri serverUri, string username, string password) : base(new NonStreamBufferingWebClient(serverUri, username, password))
    //     {
    //         _client = new NonStreamBufferingWebClient(serverUri, username, password);
    //     }
    //
    ...
    //         {
    //             // If the JSON response contains an exception message, throw a PanoramaServerException
    //             var serverError = PanoramaUtil.GetIfErrorInResponse(response);
    //             if (serverError != null)
    //             {
    //                 throw new PanoramaServerException(TextUtil.LineSeparate(messageOnError, serverError.ToString()));
    //             }
    ...
    // public interface IPublishRequestClient : IRequestClient
    // {
    ...
    // {
    //     IRequestHelper Create(Uri serverUri, string username, string password);
    // }
    public class PublishWebRequestHelperFactory : IRequestHelperFactory
    {
        public IRequestHelper Create(Uri serverUri, string username, string password)
        {
            // return new PanoramaRequestHelper(new WebClientWithCredentials(serverUri, username, password));
            return new PanoramaRequestHelper(new NonStreamBufferingWebClient(serverUri, username, password));
        }
    }
}
