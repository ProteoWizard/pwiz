    ...
    public class AuditLogTest : AbstractFunctionalTestEx
    {
        ...
        private static readonly LogEntryMessages[] LOG_ENTRY_MESSAGESES =
        {
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, MessageType.changed_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                    ...
                    "\"{6:MassType_Average}\""),
                new LogMessage(LogLevel.summary, MessageType.changed_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                ...
                new[]
                {
                    new LogMessage(LogLevel.undo_redo, MessageType.changed_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                        "{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_PrecursorMassType}",
                        "\"{6:MassType_Average}\""),
                    new LogMessage(LogLevel.all_info, MessageType.changed_from_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                        "{0:Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_PrecursorMassType}",
                        "\"{6:MassType_Monoisotopic}\"",
                        "\"{6:MassType_Average}\""),
                }),
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, MessageType.changed_from_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                    ...
                    "\"Thermo\"",
                    "\"Thermo TSQ Quantiva\""),
                new LogMessage(LogLevel.summary, MessageType.changed_from_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                ...
                new[]
                {
                    ...
                    new LogMessage(LogLevel.all_info, MessageType.changed_from_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                        ...
                        "\"Thermo\"",
                        "\"Thermo TSQ Quantiva\""),
                    new LogMessage(LogLevel.all_info, MessageType.contains, SrmDocument.DOCUMENT_TYPE.none, string.Empty, true,
            ...
            new LogEntryMessages(
                ...
                new[]
                {
                    ...
                    new LogMessage(LogLevel.all_info, MessageType.changed_from_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                        ...
                        "\"None\"",
                        "\"SCIEX\""),
                    new LogMessage(LogLevel.all_info, MessageType.is_, SrmDocument.DOCUMENT_TYPE.none, string.Empty, true,
            ...
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, MessageType.changed, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                ...
                new LogMessage(LogLevel.summary, MessageType.changed, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                ...
                new[]
                {
                    new LogMessage(LogLevel.undo_redo, MessageType.changed, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                        "{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Filter}{2:PropertySeparator}{0:TransitionFilter_MeasuredIons}"),
                    new LogMessage(LogLevel.all_info, MessageType.added_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                        "{0:Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Filter}{2:PropertySeparator}{0:TransitionFilter_MeasuredIons}",
            ...
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, MessageType.removed_from, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                    "{1:DataSettings_AnnotationDefs}",
                    "\"SubjectId\""),
                new LogMessage(LogLevel.summary, MessageType.removed_from, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                ...
                new[]
                {
                    new LogMessage(LogLevel.undo_redo, MessageType.removed_from, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                        "{1:DataSettings_AnnotationDefs}",
                        "\"SubjectId\""),
                    new LogMessage(LogLevel.all_info, MessageType.removed_from, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                        "{0:Settings}{2:PropertySeparator}{0:SrmSettings_DataSettings}{2:TabSeparator}{0:DataSettings_AnnotationDefs}",
                        "\"SubjectId\""),
                }),
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, MessageType.added_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                    "{1:DataSettings_AnnotationDefs}",
                    "\"SubjectId\""),
                new LogMessage(LogLevel.summary, MessageType.added_to, SrmDocument.DOCUMENT_TYPE.none, string.Empty, false,
                    "{0:Settings}{2:PropertySeparator}{0:SrmSettings_DataSettings}{2:TabSeparator}{0:DataSettings_AnnotationDefs}",
                    "\"SubjectId\""),
                new[]
                {
