        ...
        private List<UnlocalizedProperty> GetUnlocalizedProperties(Type T, PropertyPath path)
        {
            ...
            foreach (var property in properties)
            {
                ...
                if (!property.IgnoreName)
                {
                    ...
                    {
                        names = new[] { parentString + "_" + property.PropertyName };
                    }
            ...
            new LogEntryMessages(
                ...
                new[]
                {
                    ...
                    new LogMessage(LogLevel.all_info, MessageType.is_, string.Empty, true,
                        "{0:Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_CollisionEnergy}{2:PropertySeparator}{0:CollisionEnergyRegression_StepSize}",
                        "{3:1}"),
                    new LogMessage(LogLevel.all_info, MessageType.is_, string.Empty, true,
                        "{0:Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_CollisionEnergy}{2:PropertySeparator}{0:CollisionEnergyRegression_StepCount}",
                        "{3:5}"),
                }),
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, MessageType.changed_from_to, string.Empty, false,
                ...
                new[]
                {
                    new LogMessage(LogLevel.all_info, MessageType.changed_from_to, string.Empty, false,
                        ...
                        "\"SCIEX\""),
                    new LogMessage(LogLevel.all_info, MessageType.is_, string.Empty, true,
                        "{0:Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_DeclusteringPotential}{2:PropertySeparator}{0:DeclusteringPotentialRegression_Slope}",
                        "{3:0}"),
                    new LogMessage(LogLevel.all_info, MessageType.is_, string.Empty, true,
                        "{0:Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_DeclusteringPotential}{2:PropertySeparator}{0:DeclusteringPotentialRegression_Intercept}",
                        "{3:80}"),
                    new LogMessage(LogLevel.all_info, MessageType.is_, string.Empty, true,
                        "{0:Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_DeclusteringPotential}{2:PropertySeparator}{0:DeclusteringPotentialRegression_StepSize}",
                        "{3:10}"),
                    new LogMessage(LogLevel.all_info, MessageType.is_, string.Empty, true,
                        "{0:Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_DeclusteringPotential}{2:PropertySeparator}{0:DeclusteringPotentialRegression_StepCount}",
                        "{3:3}"),
                }),
            new LogEntryMessages(
