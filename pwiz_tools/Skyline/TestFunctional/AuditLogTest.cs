    ...
    public class AuditLogTest : AbstractFunctionalTestEx
    {
        ...
        public class LogEntry
        {
            ...
            private static string LogMessageToCode(LogMessage msg, int indentLvl = 0)
            {
                ...
                var result = string.Format(indent + "new LogMessage(LogLevel.{0}, LogMessage.MessageType.{1}, string.Empty, {2},\r\n", msg.Level, msg.Type, msg.Expanded ? "true" : "false");
            ...
            public void Verify()
            {
                ...
                if (ExpectedMessages.ExpectedUndoRedo.Type != LogMessage.MessageType.log_enabled &&
                    ExpectedMessages.ExpectedUndoRedo.Type != LogMessage.MessageType.log_disabled)
                {
                    // Test Undo-Redo
                    RunUI(() => SkylineWindow.Undo());
        ...
        {	
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, LogMessage.MessageType.log_enabled, string.Empty, false),
                new LogMessage(LogLevel.summary, LogMessage.MessageType.log_enabled, string.Empty, false),
                new[]
                {
                    new LogMessage(LogLevel.all_info, LogMessage.MessageType.log_enabled, string.Empty, false),
                }),
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, LogMessage.MessageType.changed_to, string.Empty, false,
                    ...
                    "\"Average\""),
                new LogMessage(LogLevel.summary, LogMessage.MessageType.changed_to, string.Empty, false,
                    "{0:SrmDocument_Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_PrecursorMassType}",
                    "\"Average\""),
                new[]
                {
                    new LogMessage(LogLevel.all_info, LogMessage.MessageType.changed_from_to, string.Empty, false,
                        "{0:SrmDocument_Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_PrecursorMassType}",
                        "\"Monoisotopic\"",
                        "\"Average\""),
                }),
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, LogMessage.MessageType.changed_from_to, string.Empty, false,
                    ...
                    "\"Thermo\"",
                    "\"Thermo TSQ Quantiva\""),
                new LogMessage(LogLevel.summary, LogMessage.MessageType.changed_from_to, string.Empty, false,
                    "{0:SrmDocument_Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Prediction}{2:PropertySeparator}{0:TransitionPrediction_CollisionEnergy}",
                    "\"Thermo\"",
                    "\"Thermo TSQ Quantiva\""),
                new[]
                {
                    new LogMessage(LogLevel.all_info, LogMessage.MessageType.changed_from_to, string.Empty, false,
                        ...
                        "\"Thermo\"",
                        "\"Thermo TSQ Quantiva\""),
                    new LogMessage(LogLevel.all_info, LogMessage.MessageType.contains, string.Empty, true,
                    ...
                    new LogMessage(LogLevel.all_info, LogMessage.MessageType.is_, string.Empty, true,
            ...
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, LogMessage.MessageType.changed, string.Empty, false,
                ...
                new LogMessage(LogLevel.summary, LogMessage.MessageType.changed, string.Empty, false,
                    "{0:SrmDocument_Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Filter}{2:PropertySeparator}{0:TransitionFilter_MeasuredIons}"),
                new[]
                {
                    new LogMessage(LogLevel.all_info, LogMessage.MessageType.added_to, string.Empty, false,
                        "{0:SrmDocument_Settings}{2:PropertySeparator}{0:SrmSettings_TransitionSettings}{2:TabSeparator}{0:TransitionSettings_Filter}{2:PropertySeparator}{0:TransitionFilter_MeasuredIons}",
            ...
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, LogMessage.MessageType.removed, string.Empty, false,
                    "{1:DataSettings_AnnotationDefs}{2:ElementTypeSeparator}\"SubjectId\""),
                new LogMessage(LogLevel.summary, LogMessage.MessageType.removed_from, string.Empty, false,
                    "{0:SrmDocument_Settings}{2:PropertySeparator}{0:SrmSettings_DataSettings}{2:TabSeparator}{0:DataSettings_AnnotationDefs}",
                    "\"SubjectId\""),
                new[]
                {
                    new LogMessage(LogLevel.all_info, LogMessage.MessageType.removed_from, string.Empty, false,
                        "{0:SrmDocument_Settings}{2:PropertySeparator}{0:SrmSettings_DataSettings}{2:TabSeparator}{0:DataSettings_AnnotationDefs}",
                        "\"SubjectId\""),
                }),
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, LogMessage.MessageType.added, string.Empty, false,
                    "{1:DataSettings_AnnotationDefs}{2:ElementTypeSeparator}\"SubjectId\""),
                new LogMessage(LogLevel.summary, LogMessage.MessageType.added_to, string.Empty, false,
                    "{0:SrmDocument_Settings}{2:PropertySeparator}{0:SrmSettings_DataSettings}{2:TabSeparator}{0:DataSettings_AnnotationDefs}",
                    "\"SubjectId\""),
                new[]
                {
            ...
            new LogEntryMessages(
                new LogMessage(LogLevel.undo_redo, LogMessage.MessageType.log_disabled, string.Empty, false),
                new LogMessage(LogLevel.summary, LogMessage.MessageType.log_disabled, string.Empty, false),
                new[]
                {
                    new LogMessage(LogLevel.all_info, LogMessage.MessageType.log_disabled, string.Empty, false),
                }),
        };
        #endregion
