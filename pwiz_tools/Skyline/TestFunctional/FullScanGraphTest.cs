    ...
    public class FullScanGraphTest : AbstractFunctionalTestEx
    {
        ...
        protected override void DoTest()
        {
            ...
            var expectedPropertiesPrecursor = new Dictionary<string, object> {
                ...
                {"ObservedIonMobility", string.Format(GraphsResources.GraphFullScan_ToolTip_ObservedValueWithErrorFormat,
                    (3.381).ToString(CultureInfo.CurrentCulture), (-2.77).ToString(CultureInfo.CurrentCulture)) + " msec"},
                {"IsolationWindow","50:2000 (-975:+975)"},
                {"PeakRetentionTime",32.95.ToString(CultureInfo.CurrentCulture)},
            ...
            var expectedPropertiesProduct = new Dictionary<string, object> {
                ...
                {"ObservedIonMobility", string.Format(GraphsResources.GraphFullScan_ToolTip_ObservedValueWithErrorFormat,
                    (3.45).ToString(CultureInfo.CurrentCulture), (3.74).ToString(CultureInfo.CurrentCulture)) + " msec"},
                {"IsolationWindow","50:2000 (-975:+975)"},
            ...
            var expectedPropertiesProduct2 = new Dictionary<string, object>
            {
                ...
                { "ObservedIonMobility", string.Format(GraphsResources.GraphFullScan_ToolTip_ObservedValueWithErrorFormat,
                    (5.727).ToString(CultureInfo.CurrentCulture), (0.18).ToString(CultureInfo.CurrentCulture)) + " msec" },
                { "IsolationWindow", "50:2000 (-975:+975)" },
                { "PeakRetentionTime", 33.03.ToString(CultureInfo.CurrentCulture) },
                {
                    "IonMobilityRange",
