    ...
    public class SplitGraphTest : AbstractFunctionalTest
    {
        ...
        protected override void DoTest()
        {
            ...
            RunUI(() =>
                {
                    ...
                    AssertCurveListsSame(graphChromatogram.CurveList,
                                         peakAreaSummary.GraphControl.GraphPane.CurveList.FindAll(c => c.Tag is IdentityPath).ToList<CurveItem>());
            ...
            AssertCurveListsSame(graphChromatogram.GetCurveList(graphChromatogramGraphControl.MasterPane.PaneList[0]),
                peakAreaSummary.GraphControl.MasterPane.PaneList[0].CurveList.FindAll(c => c.Tag is IdentityPath).ToList<CurveItem>());
            AssertCurveListsSame(graphChromatogram.GetCurveList(graphChromatogramGraphControl.MasterPane.PaneList[1]),
                peakAreaSummary.GraphControl.MasterPane.PaneList[1].CurveList.FindAll(c => c.Tag is IdentityPath).ToList<CurveItem>());
        }
