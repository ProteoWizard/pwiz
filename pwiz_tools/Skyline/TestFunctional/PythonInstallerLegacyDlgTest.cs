...
namespace pwiz.SkylineTestFunctional
{
    ...
    public class PythonInstallerLegacyDlgTest : AbstractFunctionalTest
    {
        ...
        private static void TestDlgLoadBoth()
        {
            ...
            var pythonInstaller = ShowDialog<PythonInstallerLegacyDlg>(() => InstallProgram(ppc, packageUris, false));
        ...
        {
            var ppc = new ProgramPathContainer(PYTHON, VERSION_27);
            var pythonInstaller = ShowDialog<PythonInstallerLegacyDlg>(() => InstallProgram(ppc, new String[0], false));
            WaitForConditionUI(5 * 1000, () => pythonInstaller.IsLoaded);
        ...
        private static PythonInstallerLegacyDlg FormatPythonInstaller(bool cancelDownload, bool downloadSuccess,
                                                             bool installSuccess)
        {
            var ppc = new ProgramPathContainer(PYTHON, VERSION_27);
        ...
        private static void SetPipInstallResults(PythonInstallerLegacyDlg pythonInstallerLegacyDlg, bool cancelDownload,
                                                 bool downloadSuccess, bool connectSuccess, bool installSuccess)
        {
            RunUI(() =>
                {
                    pythonInstallerLegacyDlg.TestPipDownloadClient = new TestAsynchronousDownloadClient
                        {
                            CancelDownload = cancelDownload,
                            DownloadSuccess = downloadSuccess
                        };
                    pythonInstallerLegacyDlg.TestPipeSkylineProcessRunner = new TestSkylineProcessRunner
                        {
                            ConnectSuccess = connectSuccess,
                            ExitCode = installSuccess ? 0 : 1
                        };
                    pythonInstallerLegacyDlg.TestingPip = true;
                });
        }
        ...
        private static PythonInstallerLegacyDlg FormatPackageInstallerOnlyExes(bool cancelDownload, bool downloadSuccess, bool installSuccess)
        {
        ...
        private static PythonInstallerLegacyDlg FormatPackageInstallerOnlySources(bool cancelDownload, bool downloadSuccess,
        ...
        private static PythonInstallerLegacyDlg FormatPackageInstallerBothTypes(bool cancelDownload, bool downloadSuccess,
                                                                       bool connectSuccess, bool installSuccess)
        {
            return FormatPackageInstaller(cancelDownload, downloadSuccess, connectSuccess, installSuccess,
        ...
        private static PythonInstallerLegacyDlg FormatPackageInstaller(bool cancelDownload, bool downloadSuccess,
        ...
        {
            var pythonInstaller =
                ShowDialog<PythonInstallerLegacyDlg>(
                    () =>
        ...
        {
            using (var dlg = new PythonInstallerLegacyDlg(ppc, packageUris, installed, null))
            {
