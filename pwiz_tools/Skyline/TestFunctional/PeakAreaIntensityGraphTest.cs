...
{
    [TestClass]
    public class PeakAreaIntensityGraphTest : AbstractFunctionalTest
    {
        [TestMethod]
        public void TestPeakAreaIntensityGraph()
        {
            TestFilesZip = @"TestFunctional\PeakAreaIntensityGraphTest.zip";
            RunFunctionalTest();
        }
