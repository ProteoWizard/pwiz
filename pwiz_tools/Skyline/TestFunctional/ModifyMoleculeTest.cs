...
namespace pwiz.SkylineTestFunctional
{
    ...
    public class ModifyMoleculeTest : AbstractFunctionalTest
    {
        ...
        protected override void DoTest()
        {
            ...
            Assert.AreEqual("C54H93O40N3", originalMolecule.CustomMolecule.MoleculeAndMassOffset.ToStringInvariant());
            ...
            Assert.AreEqual(newFormula, newMolecule.CustomMolecule.MoleculeAndMassOffset.ToStringInvariant());
