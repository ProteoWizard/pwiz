...
namespace pwiz.SkylineTestFunctional
{
    ...
    /// </summary>
    [TestClass]
    public class IonTypeMenuMcpConnectorTest : McpConnectorTest
    {
        [TestMethod]
        public void TestIonTypeMenuMcpConnector()
        {
            RunFunctionalTest();
        }
        ...
        protected override void DoTest()
        {
            ...
            var mainWindowForm = McpConnector.GetOpenForms()
            ...
            var children = (ControlInfo[]) McpConnector.PerformAction(mainWindowPath, @"get_children", null);
