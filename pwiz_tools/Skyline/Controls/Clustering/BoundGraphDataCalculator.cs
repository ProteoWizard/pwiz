...
namespace pwiz.Skyline.Controls.Clustering
{
    ...
    {
        protected BoundGraphDataCalculator(CancellationToken parentCancellationToken, ZedGraphControl zedGraphControl) : base(parentCancellationToken, zedGraphControl, zedGraphControl.GraphPane)
        {
        }
