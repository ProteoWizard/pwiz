    ...
    public class ActionTutorial
    {
        ...
        public void LongWaitDlgAction(SkylineWindow skylineWindow)
        {
            ...
            try
            {
                ...
                {
                    Text = StartupResources.ActionTutorial_LongWaitDlgAction_Downloading_Tutorial_Zip_File,
                    Message =
                        String.Format(
                            StartupResources
                ...
                {
                    Text =
                        StartupResources.ActionTutorial_LongWaitDlgAction_Extracting_Tutorial_Zip_File_in_the_same_directory_,
                    ProgressValue = 0
                })
                {
