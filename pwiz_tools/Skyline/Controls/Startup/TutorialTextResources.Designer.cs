...
namespace pwiz.Skyline.Controls.Startup {
    ...
    internal class TutorialTextResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Comparing PRM, DIA, and DDA.
        /// </summary>
        internal static string AcquisitionComparison_Caption {
            get {
                return ResourceManager.GetString("AcquisitionComparison_Caption", resourceCulture);
            }
        }

        /// <summary>
        ///   Looks up a localized string similar to Perform a targeted analysis in Skyline with PRM, DIA and DDA measurement data. Using four samples generated by mixing HeLa protein digest with PROCAL peptide standard at defined concentrations, compare results across three acquisition modes measured on a Quadrupole-Orbitrap-Iontrap (Tribrid) mass spectrometer. Learn how Skyline handles data from PRM, DIA and DDA experiments using the same peptide targets..
        /// </summary>
        internal static string AcquisitionComparison_Description {
            get {
                return ResourceManager.GetString("AcquisitionComparison_Description", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Peak Boundary Imputation for DIA.
        /// </summary>
        internal static string PeakBoundaryImputation_Caption {
            get {
                return ResourceManager.GetString("PeakBoundaryImputation_Caption", resourceCulture);
            }
        }

        /// <summary>
        ///   Looks up a localized string similar to Learn how to use Skyline's peak boundary imputation feature for DIA experiments. Understand how missing values affect group comparisons in untargeted proteomics and how Skyline addresses this by transferring peak boundaries from replicates where a peptide was confidently identified to replicates where it was not. Work with extracellular vesicle-enriched plasma samples to see how imputation improves data completeness for quantitative analysis..
        /// </summary>
        internal static string PeakBoundaryImputation_Description {
            get {
                return ResourceManager.GetString("PeakBoundaryImputation_Description", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Introduction to Full-Scan Acquisition Data.
        /// </summary>
        internal static string Section_Intro_Full_Scan {
            get {
                return ResourceManager.GetString("Section_Intro_Full_Scan", resourceCulture);
            }
        }
