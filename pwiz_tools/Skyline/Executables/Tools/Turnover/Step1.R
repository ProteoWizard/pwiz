...
IDP.threshold <- min.isotope.dot.product # value for filtering by Isotope Dot Product
...
ATS.threshold <- min.avg.turnover.score # average turnover score value, used for filtering data
