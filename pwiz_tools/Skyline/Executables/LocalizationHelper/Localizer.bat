cd
echo %1
dir /a C:\Windows\system32\config\systemprofile\AppData\Local\JetBrains\commandline8.2\
dir /a C:\Windows\system32\config\systemprofile\AppData\Local\JetBrains\commandline9.0\
dir /a C:\Windows\system32\config\systemprofile\AppData\Local\JetBrains\
dir /a C:\Windows\system32\config\systemprofile\AppData\Local\
dir /a C:\Windows\system32\config\systemprofile\AppData\
dir /a C:\Windows\system32\config\systemprofile\
if not exist C:\Windows\system32\config\systemprofile\AppData\Local/JetBrains/commandline8.2/(
  Echo "Debug 1"
)
if Exist C:\Windows\system32\config\systemprofile\AppData\Local/JetBrains/commandline9.0/(
  Echo "Debug 2"
)
if Exist C:\Windows\system32\config\systemprofile\AppData\Local\JetBrains\commandline8.2\(
  Echo "Debug 3"
)
if Exist C:\Windows\system32\config\systemprofile\AppData\Local\JetBrains\commandline9.0\(
  Echo "Debug 4"
)
if Exist Z:\Windows\system32\config\systemprofile\AppData\Local\JetBrains\commandline8.2\(
  Echo "Debug 5"
)
if Exist Z:\Windows\system32\config\systemprofile\AppData\Local\JetBrains\commandline9.0\(
  Echo "Debug 6"
)
