...
{
    /// <summary>
    /// Base class for AutoQC unit tests. Extends SharedBatchTest.AbstractUnitTest
    /// and adds AutoQC-specific properties for test configuration (internet access,
    /// perf tests, small molecule tests, etc.).
    ///
