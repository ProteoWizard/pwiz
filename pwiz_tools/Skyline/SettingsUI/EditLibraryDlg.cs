...
namespace pwiz.Skyline.SettingsUI
{
    public partial class EditLibraryDlg : FormEx
    {
        ...
        public void OkDialog()
        {
            ...
            {
                using (var longWait = new LongWaitDlg{ Text = SettingsUIResources.EditLibraryDlg_OkDialog_Loading_chromatogram_library })
                {
                    Library lib = null;
                    try
                    {
...
// ReSharper disable once EmptyGeneralCatchClause
        ...
        public static string GetLibraryPath(IWin32Window parent, string fileName)
        {
            using (var dlg = new OpenFileDialog
            {
                ...
                Filter = TextUtil.FileDialogFiltersAll(TextUtil.FileDialogFilter(SettingsUIResources.EditLibraryDlg_GetLibraryPath_Spectral_Libraries,
