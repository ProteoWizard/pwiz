...
//                Height = ptCorner.Y - Top;
        ...
        public void ShowGraph()
        {
            ...
            if (!calc.IsUsable)
            {
                ...
                {
                    Text = SettingsUIResources.EditRTDlg_ShowGraph_Initializing,
                    Message = string.Format(SettingsUIResources.EditRTDlg_ShowGraph_Initializing__0__calculator, calc.Name)
                })
                {
                    try
                    {
