...
namespace pwiz.Skyline.SettingsUI
{
    public partial class EditOptimizationLibraryDlg : FormEx
    {
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                Title = SettingsUIResources.EditOptimizationLibraryDlg_btnOpen_Click_Open_Optimization_Library,
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            {
                Title = SettingsUIResources.EditOptimizationLibraryDlg_btnCreate_Click_Create_Optimization_Library,
                InitialDirectory = Settings.Default.ActiveDirectory,
        ...
        public class LibraryGridViewDriver : PeptideGridViewDriver<DbOptimization>
        {
            ...
            private void AddOptimizationLibrary(OptimizationLibrary optLibrary, SrmDocument document)
            {
                ...
                {
                    Text = SettingsUIResources.LibraryGridViewDriver_AddOptimizationLibrary_Adding_optimization_library,
                    Message = string.Format(SettingsUIResources.LibraryGridViewDriver_AddOptimizationLibrary_Adding_optimization_values_from__0_, optLibrary.DatabasePath),
