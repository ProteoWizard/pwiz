    ...
    public partial class BuildBackgroundProteomeDlg : ModeUIInvariantFormEx  // This dialog is inherently proteomic, never wants the "peptide"->"molecule" translation
    {
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            ...
            using (var openFileDialog = new OpenFileDialog
            {
                ...
                Title = SettingsUIResources.BuildBackgroundProteomeDlg_btnOpen_Click_Open_Background_Protoeme,
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            using (var saveFileDialog = new SaveFileDialog
            {
                Filter = filterProtDb,
                InitialDirectory = Settings.Default.ProteomeDbDirectory,
                Title = SettingsUIResources.BuildBackgroundProteomeDlg_btnCreate_Click_Create_Background_Proteome,
        ...
        private void btnAddFastaFile_Click(object sender, EventArgs e)
        {
            using (var openFileDialog = new OpenFileDialog
            {
                Title = SettingsUIResources.BuildBackgroundProteomeDlg_btnAddFastaFile_Click_Add_FASTA_File,
        ...
        private void RefreshStatus()
        {
            if (File.Exists(textPath.Text))
            {
                ...
                try
                {
                    ...
                    {
                        Text = SettingsUIResources.BuildBackgroundProteomeDlg_RefreshStatus_Loading_Proteome_File,
                        Message =
                            string.Format(
