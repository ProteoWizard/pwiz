...
namespace pwiz.Skyline.SettingsUI
{
    public partial class EditPeakScoringModelDlg : FormEx, IMultipleViewProvider
    {
        ...
        public bool SetScoringModel(Control owner, IPeakScoringModel scoringModel, IFeatureScoreProvider scoreProvider = null)
        {
            ...
            using (var longWaitDlg = new LongWaitDlg { Text = SettingsUIResources.EditPeakScoringModelDlg_TrainModelClick_Scoring })
            {
        ...
        public void TrainModel(bool suppressWeights = false)
        {
            ...
            // Train the model.
            using (var longWaitDlg = new LongWaitDlg { Text = SettingsUIResources.EditPeakScoringModelDlg_TrainModel_Training})
            {
            ...
            try
            {
                ...
                {
                    Text = SettingsUIResources.EditPeakScoringModelDlg_TrainModel_Calculating,
