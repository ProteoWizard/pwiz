    ...
    public partial class BuildLibraryDlg : FormEx, IMultipleViewProvider
    {
        ...
        public static string[] ShowAddFile(Form parent, String initialDirectory)
        {
            ...
            using (var dlg = new OpenFileDialog
                {
                    Title = SettingsUIResources.BuildLibraryDlg_btnAddFile_Click_Add_Input_Files,
        ...
        private void btnAddDirectory_Click(object sender, EventArgs e)
        {
            using (var dlg = new FolderBrowserDialog
                {
                    Description = SettingsUIResources.BuildLibraryDlg_btnAddDirectory_Click_Add_Input_Directory,
        ...
        public void AddDirectory(string dirPath)
        {
            using (var longWaitDlg = new LongWaitDlg
                {
                    Text = SettingsUIResources.BuildLibraryDlg_AddDirectory_Find_Input_Files,
                })
            {
                try
                {
