...
namespace pwiz.Skyline.SettingsUI.IonMobility
{
    public partial class EditDriftTimePredictorDlg : FormEx
    {
        ...
        public void GetDriftTimesFromResults()
        {
            ...
            {
                var driftTable = new MeasuredDriftTimeTable(gridMeasuredDriftTimes);
                var tempDriftTimePredictor = new IonMobilityPredictor(@"tmp", driftTable.GetTableMeasuredIonMobility(cbOffsetHighEnergySpectra.Checked, Units), null, null, IonMobilityWindowWidthCalculator.IonMobilityPeakWidthType.resolving_power, 30, 0, 0);
