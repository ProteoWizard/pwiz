/*
 * Moved from Model.Databinding to Properties to avoid UI/model coupling and align SettingsList classes.
 */
using System;
...
namespace pwiz.Skyline.Properties
{
    ...
    public class ReportOrViewSpecList : SerializableSettingsList<ReportOrViewSpec>, IItemEditor<ReportOrViewSpec>
    {
        ...
        public ReportOrViewSpecList(ReportSpecList oldList)
        {
            ...
            var convertedReports = ReportSharing.ConvertAll(oldReports, new Model.SrmDocument(SrmSettingsList.GetDefault()));
        ...
        {
            get { return PropertiesResources.ReportSpecList_Title_Edit_Reports; }
        }

        public override string Label
        {
            get { return PropertiesResources.ReportSpecList_Label_Report; }
        }
