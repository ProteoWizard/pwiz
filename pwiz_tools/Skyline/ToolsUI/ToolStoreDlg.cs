    ...
    public partial class ToolStoreDlg : FormEx
    {
        ...
        public void DownloadSelectedTool()
        {
            try
            {
                ...
                using (var dlg = new LongWaitDlg {ProgressValue = 0, Message = string.Format(ToolsUIResources.ToolStoreDlg_DownloadSelectedTool_Downloading__0_, _tools[listBoxTools.SelectedIndex].Name)})
                {
