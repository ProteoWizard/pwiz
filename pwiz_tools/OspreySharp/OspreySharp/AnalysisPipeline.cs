...
namespace pwiz.OspreySharp
{
    ...
    public partial class AnalysisPipeline
    {
        ...
        /// </summary>
        internal List<IsolationWindow> ExtractIsolationWindows(List<Spectrum> spectra)
        {
        ...
        // etc.) reads PerFileScoring.PerFileScoringTask.CAL_TOP_N_FRAGMENTS from PerFileScoringTask;
        ...
        /// </summary>
        internal List<XicData> ExtractTopNFragmentXics(
            LibraryEntry entry,
        ...
        /// </summary>
        internal static double PearsonOverRange(double[] x, double[] y, int start, int end)
        {
            int n = end - start + 1;
            if (n < 3)
                return double.NaN;
        ...
        /// </summary>
        internal List<FdrEntry> RunCoelutionScoring(
        ...
        /// </summary>
        internal static bool HasTopNFragmentMatch(
            ...
            OspreyConfig config)
        {
            ...
            int nTop = Math.Min(nFrags, PerFileScoring.PerFileScoringTask.CAL_TOP_N_FRAGMENTS);
            int[] topIndices;
            if (nFrags <= PerFileScoring.PerFileScoringTask.CAL_TOP_N_FRAGMENTS)
            {
                topIndices = new int[nFrags];
                for (int i = 0; i < nFrags; i++)
                    topIndices[i] = i;
        ...
        /// </summary>
        internal byte CountTop6Matches(
            LibraryEntry entry, Spectrum spectrum, OspreyConfig config)
        {
            if (entry.Fragments == null || entry.Fragments.Count == 0)
                return 0;
        ...
        /// </summary>
        internal List<FdrEntry> DeduplicateDoubleCounting(
        ...
        internal List<FdrEntry> DeduplicatePairs(List<FdrEntry> entries)
        {
        ...
        internal static int BinarySearchLowerBound(double[] sortedArray, double value)
        {
            int lo = 0;
