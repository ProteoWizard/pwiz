...
int BlibMaker::parseNextSwitch(int i, int argc, char* argv[])
{
    ...
    if (switchName == 'v')
        ...
        ostream &out = (fname != NULL) ? fout : cout;
        ...
        out << "-- This file was generated by the \"blibuild -d\" command during the ProteoWizard build process. Do not edit, it may be overwritten and your changes will be lost." << endl;
        out << endl;
