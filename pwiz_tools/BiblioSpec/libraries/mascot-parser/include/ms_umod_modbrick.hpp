/*
##############################################################################
# file: ms_umod_modbrick.hpp                                                #
# 'msparser' toolkit                                                         #
# Represents modbrick object from unimod.xml file                        #
##############################################################################
# COPYRIGHT NOTICE                                                           #
# Copyright 1998-2006 Matrix Science Limited  All Rights Reserved.           #
#                                                                            #
##############################################################################
 * @(#)$Source: /vol/cvsroot/parser/inc/ms_umod_modbrick.hpp,v $
 * @(#)$Revision: 1.8 $
 * @(#)$Date: 2010-09-06 16:18:57 $
##############################################################################
 */

#ifndef MS_UMOD_MODBRICK_HPP
#define MS_UMOD_MODBRICK_HPP
...
namespace matrix_science {
    ...
    //! Represents a modification brick object in <tt>unimod.xml</tt>.
    class MS_MASCOTRESFILE_API ms_umod_modbrick: public ms_xml_IValidatable
    {
    ...
    public:
        ...
        //! Copying constructor.
        ms_umod_modbrick(const ms_umod_modbrick& src);

        //! Destructor.
        virtual ~ms_umod_modbrick();

        //! Call this member if you want to start again.
        void defaultValues();

        //! Copies all content from another instance.
        void copyFrom(const ms_umod_modbrick* right);

#ifndef SWIG
        //! C++ style assignment operator.
        ms_umod_modbrick& operator=(const ms_umod_modbrick& right);
#endif
        ...
        //! Returns the \c full_name attribute.
