...
namespace pwiz.Osprey.Core
{
    ...
    /// significant Skyline-internal dependencies. Once Osprey gains
    /// dependencies under <c>pwiz_tools/Shared</c>, this should move to
    /// <c>pwiz_tools/Shared/CommonUtil/SystemUtil</c> as a
    /// <c>SimpleFileSaver</c> shared by Osprey + SkylineBatch +
    /// AutoQC.
    /// </summary>
    public sealed class FileSaver : IDisposable
    {
        ...
        /// throws on overwrite -- Osprey's per-file artifacts are
        ...
        public void Commit()
        {
            ...
            // exception and writes to Trace.TraceWarning. Osprey's
