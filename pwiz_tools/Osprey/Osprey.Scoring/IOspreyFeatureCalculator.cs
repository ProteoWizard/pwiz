...
namespace pwiz.Osprey.Scoring
{
        ...
        public double Calculate(OspreyScoringContext context, IOspreySummaryPeakData peakData)
        {
            ...
            if (detailed == null)
                throw new InvalidOperationException(
                    @"This Osprey feature calculator requires IOspreyDetailedPeakData; a narrower peak-data tier was provided.");
    ...
    public abstract class ApexSpectrumOspreyFeatureCalculator : IOspreyFeatureCalculator
    {
        ...
        public double Calculate(OspreyScoringContext context, IOspreySummaryPeakData peakData)
        {
            ...
            if (apex == null)
                throw new InvalidOperationException(
                    @"This Osprey feature calculator requires IOspreyApexSpectrumPeakData; a narrower peak-data tier was provided.");
    ...
    public abstract class ApexSpectraOspreyFeatureCalculator : IOspreyFeatureCalculator
    {
        ...
        public double Calculate(OspreyScoringContext context, IOspreySummaryPeakData peakData)
        {
            ...
            if (spectra == null)
                throw new InvalidOperationException(
                    @"This Osprey feature calculator requires IOspreyApexSpectraPeakData; a narrower peak-data tier was provided.");
