...
namespace pwiz.Osprey.Test
{
    ...
    public class LibraryFragmentReleaseTest
    {
        ...
        private static void ValidateEveryLegThatHoldsTheLibraryReleasesIt()
        {
            ...
            AssertRunsOnLeg(true, OspreyCommandArgs.ARG_TASK + SecondPassFdrTask.TASK_NAME, ForTask(HpcTask.SecondPassFdr));
            ...
            AssertRunsOnLeg(false, OspreyCommandArgs.ARG_TASK + FirstPassFdrTask.TASK_NAME, ForTask(HpcTask.FirstPassFdr));
