...
public class ReaderSciexHarnessTests
{
    ...
    //  - swath.api.wiff2: same timezone issue, plus isolation-window offsets stored as
    //    absolute m/z bounds (need to subtract target_m_z), plus the CWT peak picker keeps
    //    ~3x more points than the vendor centroider.
    // Re-add Reader_Sciex_ZenoTofMsMsEad / Reader_Sciex_SwathApi when those gaps close out.
