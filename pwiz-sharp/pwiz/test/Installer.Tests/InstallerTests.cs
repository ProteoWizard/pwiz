...
/// registry state + a quick CLI smoke (<c>msconvert.exe</c> over vendor fixtures),
/// then silently uninstalls and verifies cleanup.
///
/// Test policy:
/// <list type="bullet">
...
public class InstallerTests
{
    ...
    private const string AppName = "ProteoWizard-Sharp";
