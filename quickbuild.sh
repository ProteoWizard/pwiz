...
then
cd $PWIZ_ROOT/libraries ; tar -xkjvf boost-build.tar.bz2
fi
...
echo "Building pwiz..."
echo "export BOOST_BUILD_PATH=$PWIZ_ROOT/libraries/boost-build ; $PWIZ_BJAM $2 $3 $4 $5 --toolset=$BJAM_TOOLSET $PWIZ_ROOT"
export BOOST_BUILD_PATH=$PWIZ_ROOT/libraries/boost-build ; $PWIZ_BJAM $2 $3 $4 $5 "--toolset=$BJAM_TOOLSET" $PWIZ_ROOT
