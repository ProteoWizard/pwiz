...
if [ "$IAGREE" = 1 ]; then
    BUILD_TARGET=(
        "pwiz_tools/Commandline/MsConvert/src/MsConvert.csproj"
        "pwiz/data/vendor_readers/Thermo/Thermo.csproj"
        "pwiz/data/vendor_readers/Bruker/Bruker.csproj"
    )
else
    BUILD_TARGET=("pwiz_tools/Commandline/MsConvert/src/MsConvert.csproj")
fi
...
TEST_TARGET=(
    "pwiz/utility/test/Util.Tests.csproj"
    "pwiz/data/common/test/Common.Tests.csproj"
    "pwiz/data/msdata/test/MsData.Tests.csproj"
    "pwiz/utility/bindings/NativeAot/test/MsData.NativeAot.Tests.csproj"
    "pwiz/data/identdata/test/IdentData.Tests.csproj"
    "pwiz/analysis/test/Analysis.Tests.csproj"
    "pwiz_tools/Commandline/MsConvert/test/MsConvert.Tests.csproj"
)
[ "$IAGREE" = 1 ] && TEST_TARGET+=("pwiz/data/vendor_readers/Thermo/test/Thermo.Tests.csproj")
...
[ "$IAGREE" = 1 ] && TEST_TARGET+=("pwiz/data/vendor_readers/Waters/test/Waters.Tests.csproj")
...
[ "$IAGREE" = 1 ] && TEST_TARGET+=("pwiz/data/vendor_readers/Bruker/test/Bruker.Tests.csproj")
...
TEST_TARGET+=(
    "pwiz/data/vendor_readers/Agilent/test/Agilent.Tests.csproj"
    "pwiz/data/vendor_readers/Sciex/test/Sciex.Tests.csproj"
    "pwiz/data/vendor_readers/Shimadzu/test/Shimadzu.Tests.csproj"
    "pwiz/data/vendor_readers/UIMF/test/UIMF.Tests.csproj"
    "pwiz/data/vendor_readers/Mobilion/test/Mobilion.Tests.csproj"
)
...
if [ "$IAGREE" = 1 ]; then
    echo "##teamcity[progressMessage 'scripts/installer/build-linux.sh']"
    bash "$SCRIPT_DIR/scripts/installer/build-linux.sh" \
