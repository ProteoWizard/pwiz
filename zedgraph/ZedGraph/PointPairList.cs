...
*/
	...
	#region Constructors
		...
		/// type double.
		/// </summary>
        public PointPairList( IList<double> x, IList<double> y )
		{
			Add( x, y );
		...
		/// type double.
		/// </summary>
        public PointPairList( IList<double> x, IList<double> y, IList<double> baseVal )
		{
			Add( x, y, baseVal );
	...
	#region Methods
		...
		/// </summary>
        /// <param name="x">A list or array array of X values</param>
        /// <param name="y">A list or array array of Y values</param>
		/// <returns>The zero-based ordinal index where the last point was added in the list,
		/// or -1 if no points were added.</returns>
		...
		/// smaller array is padded with <see cref="PointPairBase.Missing"/> values.
		/// </summary>
        /// <param name="x">A list or array of X values</param>
        /// <param name="y">A list or array of Y values</param>
        /// <param name="z">A list or array of Z or lower-dependent axis values</param>
		/// <returns>The zero-based ordinal index where the last point was added in the list,
		/// or -1 if no points were added.</returns>
        public void Add( IList<double> x, IList<double> y, IList<double> z )
		{
			int 		len = 0;
		...
		*/
		...
		/// changed.
		/// </remarks>
		/// <param name="x">A list or array of double values that will replace the existing X
		/// values in the <see cref="PointPairList"/>.</param>
        public void SetX( IList<double> x )
		{
		...
		/// changed.
		/// </remarks>
        /// <param name="y">A list or array of double values that will replace the existing Y
		/// values in the <see cref="PointPairList"/>.</param>
        public void SetY( IList<double> y )
		{
		...
		/// changed.
		/// </remarks>
        /// <param name="z">A list or array of double values that will replace the existing Z
		/// values in the <see cref="PointPairList"/>.</param>
        public void SetZ( IList<double> z )
		{
